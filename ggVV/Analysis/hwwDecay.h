...
// Fri Mar  7 20:57:25 2014 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: gg2VV_INTERFERENCE_1_unweightedEvents.root
//////////////////////////////////////////////////////////
...
#ifdef hwwDecay_cxx
hwwDecay::hwwDecay(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gg2VV_INTERFERENCE_1_unweightedEvents.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gg2VV_INTERFERENCE_1_unweightedEvents.root");
      }
...
Int_t hwwDecay::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hwwDecay::LoadTree(Long64_t entry)
{
...
void hwwDecay::Show(Long64_t entry)
{
...
Int_t hwwDecay::Cut(Long64_t entry)
{
