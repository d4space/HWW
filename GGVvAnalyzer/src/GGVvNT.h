...
#ifdef GGVvNT_cxx
GGVvNT::GGVvNT(TTree *tree) : fChain(0) 
{
...
Int_t GGVvNT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GGVvNT::LoadTree(Long64_t entry)
{
...
void GGVvNT::Show(Long64_t entry)
{
...
Int_t GGVvNT::Cut(Long64_t entry)
{
