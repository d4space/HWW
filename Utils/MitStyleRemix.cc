...
void InitHist2D(TH2 *hist, const char *xtit, const char *ytit, EColor color)
{
  hist->SetXTitle(xtit);
  hist->SetYTitle(ytit);
  hist->SetLineColor(color);
  hist->SetTitleSize  (0.05,"Y");
  hist->SetTitleOffset(1.20,"Y");
  hist->SetLabelOffset(0.014,"Y");
  hist->SetLabelSize  (0.040,"Y");
  hist->SetLabelFont  (42   ,"Y");
  hist->SetTitleSize  (0.05,"X");
  hist->SetTitleOffset(1.20,"X");
  hist->SetLabelOffset(0.014,"X");
  hist->SetLabelSize  (0.040,"X");
  hist->SetLabelFont  (42   ,"X");
  //hist->SetMarkerStyle(20);
...
void SetStyle()
{
  ...
  MITStyle->SetTitleSize  (0.05,"X");
  //MITStyle->SetTitleSize  (0.055,"X");
  MITStyle->SetTitleOffset(1.2,"X");
  //MITStyle->SetTitleOffset(1.600,"X");
  MITStyle->SetLabelOffset(0.014,"X");
  ...
  MITStyle->SetTitleSize  (0.05,"Y");
  //MITStyle->SetTitleSize  (0.055,"Y");
  MITStyle->SetTitleOffset(1.6,"Y");
  MITStyle->SetLabelOffset(0.014,"Y");
  MITStyle->SetLabelSize  (0.04,"Y");
