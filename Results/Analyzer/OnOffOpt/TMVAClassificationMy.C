...
void TMVAClassificationMy( TString myMethodList = "" )
{
   ...
   factory->AddVariable( "met",                "MissingEt", "", 'F' );
   ...
   TTree *inputTree = (TTree*)input->Get("ggTree");
   ...
   TCut sigCut = "mHig>160"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
