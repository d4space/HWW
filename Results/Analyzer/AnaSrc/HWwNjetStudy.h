...
void HWwNjetStudy::Calc_Pow_Vbf_Weight()
{
	 ...
	 if(mWW > 130 && mWW <= 143)	 WevtPow2Gen= EvtWeight *0.0674243;
	 if(mWW > 143 && mWW <= 156)	 WevtPow2Gen= EvtWeight *0.0258035;
	 if(mWW > 156 && mWW <= 169)	 WevtPow2Gen= EvtWeight *0.306305;
	 if(mWW > 169 && mWW <= 182)	 WevtPow2Gen= EvtWeight *0.183219;
	 if(mWW > 182 && mWW <= 195)	 WevtPow2Gen= EvtWeight *0.39707;
	 if(mWW > 195 && mWW <= 208)	 WevtPow2Gen= EvtWeight *0.455916;
	 if(mWW > 208 && mWW <= 221)	 WevtPow2Gen= EvtWeight *14.0881;
	 if(mWW > 221 && mWW <= 234)	 WevtPow2Gen= EvtWeight *11.5524;
	 if(mWW > 234 && mWW <= 247)	 WevtPow2Gen= EvtWeight *1.70839;
	 if(mWW > 247 && mWW <= 260)	 WevtPow2Gen= EvtWeight *0.745802;
	 if(mWW > 260 && mWW <= 273)	 WevtPow2Gen= EvtWeight *7.15276;
	 if(mWW > 273 && mWW <= 286)	 WevtPow2Gen= EvtWeight *3.66088;
	 if(mWW > 286 && mWW <= 299)	 WevtPow2Gen= EvtWeight *1.68245;
	 if(mWW > 299 && mWW <= 312)	 WevtPow2Gen= EvtWeight *1.0273;
	 if(mWW > 312 && mWW <= 325)	 WevtPow2Gen= EvtWeight *3.08885;
	 if(mWW > 325 && mWW <= 338)	 WevtPow2Gen= EvtWeight *2.32715;
	 if(mWW > 338 && mWW <= 351)	 WevtPow2Gen= EvtWeight *1.55647;
	 if(mWW > 351 && mWW <= 364)	 WevtPow2Gen= EvtWeight *1.53936;
	 if(mWW > 364 && mWW <= 377)	 WevtPow2Gen= EvtWeight *3.67855;
	 if(mWW > 377 && mWW <= 390)	 WevtPow2Gen= EvtWeight *3.15843;
	 if(mWW > 390 && mWW <= 403)	 WevtPow2Gen= EvtWeight *2.49716;
	 if(mWW > 403 && mWW <= 416)	 WevtPow2Gen= EvtWeight *2.09177;
	 if(mWW > 416 && mWW <= 429)	 WevtPow2Gen= EvtWeight *4.07234;
	 if(mWW > 429 && mWW <= 442)	 WevtPow2Gen= EvtWeight *3.46953;
	 if(mWW > 442 && mWW <= 455)	 WevtPow2Gen= EvtWeight *4.10663;
	 if(mWW > 455 && mWW <= 468)	 WevtPow2Gen= EvtWeight *3.44691;
	 if(mWW > 468 && mWW <= 481)	 WevtPow2Gen= EvtWeight *4.33924;
	 if(mWW > 481 && mWW <= 494)	 WevtPow2Gen= EvtWeight *5.14173;
	 if(mWW > 494 && mWW <= 507)	 WevtPow2Gen= EvtWeight *4.4684;
	 if(mWW > 507 && mWW <= 520)	 WevtPow2Gen= EvtWeight *4.26843;
	 if(mWW > 520 && mWW <= 533)	 WevtPow2Gen= EvtWeight *5.46912;
	 if(mWW > 533 && mWW <= 546)	 WevtPow2Gen= EvtWeight *6.51298;
	 if(mWW > 546 && mWW <= 559)	 WevtPow2Gen= EvtWeight *5.47001;
	 if(mWW > 559 && mWW <= 572)	 WevtPow2Gen= EvtWeight *4.79131;
	 if(mWW > 572 && mWW <= 585)	 WevtPow2Gen= EvtWeight *7.41821;
	 if(mWW > 585 && mWW <= 598)	 WevtPow2Gen= EvtWeight *7.23983;
	 if(mWW > 598 && mWW <= 611)	 WevtPow2Gen= EvtWeight *6.0923;
	 if(mWW > 611 && mWW <= 624)	 WevtPow2Gen= EvtWeight *9.80339;
	 if(mWW > 624 && mWW <= 637)	 WevtPow2Gen= EvtWeight *12.1198;
	 if(mWW > 637 && mWW <= 650)	 WevtPow2Gen= EvtWeight *12.467;
	 if(mWW > 650 && mWW <= 663)	 WevtPow2Gen= EvtWeight *15.81;
	 if(mWW > 663 && mWW <= 676)	 WevtPow2Gen= EvtWeight *13.4155;
	 if(mWW > 676 && mWW <= 689)	 WevtPow2Gen= EvtWeight *17.5225;
	 if(mWW > 689 && mWW <= 702)	 WevtPow2Gen= EvtWeight *13.3855;
	 if(mWW > 702 && mWW <= 715)	 WevtPow2Gen= EvtWeight *11.9089;
	 if(mWW > 715 && mWW <= 728)	 WevtPow2Gen= EvtWeight *22.0131;
	 if(mWW > 728 && mWW <= 741)	 WevtPow2Gen= EvtWeight *20.7517;
	 if(mWW > 741 && mWW <= 754)	 WevtPow2Gen= EvtWeight *20.8114;
	 if(mWW > 754 && mWW <= 767)	 WevtPow2Gen= EvtWeight *18.1008;
	 if(mWW > 767 && mWW <= 780)	 WevtPow2Gen= EvtWeight *26.2573;
	 if(mWW > 780 && mWW <= 793)	 WevtPow2Gen= EvtWeight *18.8721;
	 if(mWW > 793 && mWW <= 806)	 WevtPow2Gen= EvtWeight *22.4647;
	 if(mWW > 806 && mWW <= 819)	 WevtPow2Gen= EvtWeight *24.477;
	 if(mWW > 819 && mWW <= 832)	 WevtPow2Gen= EvtWeight *28.9273;
	 if(mWW > 832 && mWW <= 845)	 WevtPow2Gen= EvtWeight *24.9888;
	 if(mWW > 845 && mWW <= 858)	 WevtPow2Gen= EvtWeight *24.4468;
	 if(mWW > 858 && mWW <= 871)	 WevtPow2Gen= EvtWeight *28.4801;
	 if(mWW > 871 && mWW <= 884)	 WevtPow2Gen= EvtWeight *40.5839;
	 if(mWW > 884 && mWW <= 897)	 WevtPow2Gen= EvtWeight *28.2629;
	 if(mWW > 897 && mWW <= 910)	 WevtPow2Gen= EvtWeight *38.2284;
	 if(mWW > 910 && mWW <= 923)	 WevtPow2Gen= EvtWeight *38.6635;
	 if(mWW > 923 && mWW <= 936)	 WevtPow2Gen= EvtWeight *41.5045;
	 if(mWW > 936 && mWW <= 949)	 WevtPow2Gen= EvtWeight *49.6043;
	 if(mWW > 949 && mWW <= 962)	 WevtPow2Gen= EvtWeight *55.9767;
	 if(mWW > 962 && mWW <= 975)	 WevtPow2Gen= EvtWeight *60.7608;
	 if(mWW > 975 && mWW <= 988)	 WevtPow2Gen= EvtWeight *53.5028;
	 if(mWW > 988 && mWW <= 1001)	 WevtPow2Gen= EvtWeight *36.9448;
	 if(mWW > 1001 && mWW <= 1014)	 WevtPow2Gen= EvtWeight *67.8036;
	 if(mWW > 1014 && mWW <= 1027)	 WevtPow2Gen= EvtWeight *55.4323;
	 if(mWW > 1027 && mWW <= 1040)	 WevtPow2Gen= EvtWeight *70.3581;
	 if(mWW > 1040 && mWW <= 1053)	 WevtPow2Gen= EvtWeight *64.5621;
	 if(mWW > 1053 && mWW <= 1066)	 WevtPow2Gen= EvtWeight *70.8778;
	 if(mWW > 1066 && mWW <= 1079)	 WevtPow2Gen= EvtWeight *81.2333;
	 if(mWW > 1079 && mWW <= 1092)	 WevtPow2Gen= EvtWeight *99.4024;
	 if(mWW > 1092 && mWW <= 1105)	 WevtPow2Gen= EvtWeight *93.3611;
	 if(mWW > 1105 && mWW <= 1118)	 WevtPow2Gen= EvtWeight *108.25;
	 if(mWW > 1118 && mWW <= 1131)	 WevtPow2Gen= EvtWeight *127.575;
	 if(mWW > 1131 && mWW <= 1144)	 WevtPow2Gen= EvtWeight *94.0327;
	 if(mWW > 1144 && mWW <= 1157)	 WevtPow2Gen= EvtWeight *116.635;
	 if(mWW > 1157 && mWW <= 1170)	 WevtPow2Gen= EvtWeight *147.537;
	 if(mWW > 1170 && mWW <= 1183)	 WevtPow2Gen= EvtWeight *116.775;
	 if(mWW > 1183 && mWW <= 1196)	 WevtPow2Gen= EvtWeight *114.53;
	 if(mWW > 1196 && mWW <= 1209)	 WevtPow2Gen= EvtWeight *107.101;
	 if(mWW > 1209 && mWW <= 1222)	 WevtPow2Gen= EvtWeight *161.165;
	 if(mWW > 1222 && mWW <= 1235)	 WevtPow2Gen= EvtWeight *170.83;
	 if(mWW > 1235 && mWW <= 1248)	 WevtPow2Gen= EvtWeight *196.606;
	 if(mWW > 1248 && mWW <= 1261)	 WevtPow2Gen= EvtWeight *128.257;
	 if(mWW > 1261 && mWW <= 1274)	 WevtPow2Gen= EvtWeight *156.066;
	 if(mWW > 1274 && mWW <= 1287)	 WevtPow2Gen= EvtWeight *273.982;
	 if(mWW > 1287 && mWW <= 1300)	 WevtPow2Gen= EvtWeight *134.96;
	 if(mWW > 1300 && mWW <= 1313)	 WevtPow2Gen= EvtWeight *159.011;
	 if(mWW > 1313 && mWW <= 1326)	 WevtPow2Gen= EvtWeight *196.887;
	 if(mWW > 1326 && mWW <= 1339)	 WevtPow2Gen= EvtWeight *215.432;
	 if(mWW > 1339 && mWW <= 1352)	 WevtPow2Gen= EvtWeight *285.27;
	 if(mWW > 1352 && mWW <= 1365)	 WevtPow2Gen= EvtWeight *315.096;
	 if(mWW > 1365 && mWW <= 1378)	 WevtPow2Gen= EvtWeight *380.288;
	 if(mWW > 1378 && mWW <= 1391)	 WevtPow2Gen= EvtWeight *311.397;
	 if(mWW > 1391 && mWW <= 1404)	 WevtPow2Gen= EvtWeight *277.776;
	 if(mWW > 1404 && mWW <= 1417)	 WevtPow2Gen= EvtWeight *296.663;
	 if(mWW > 1417 && mWW <= 1430)	 WevtPow2Gen= EvtWeight *362.813;
