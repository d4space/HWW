...
void HWwNjetStudy::Calc_Pow_Vbf_Weight()
{
	 ...
	 if(mWW > 125 && mWW <= 136)	 WevtPow2Gen= EvtWeight *0.0787409;
	 if(mWW > 136 && mWW <= 147)	 WevtPow2Gen= EvtWeight *0.0284596;
	 if(mWW > 147 && mWW <= 158)	 WevtPow2Gen= EvtWeight *0.0391612;
	 if(mWW > 158 && mWW <= 169)	 WevtPow2Gen= EvtWeight *0.298309;
	 if(mWW > 169 && mWW <= 180)	 WevtPow2Gen= EvtWeight *0.208063;
	 if(mWW > 180 && mWW <= 191)	 WevtPow2Gen= EvtWeight *0.21631;
	 if(mWW > 191 && mWW <= 202)	 WevtPow2Gen= EvtWeight *0.303933;
	 if(mWW > 202 && mWW <= 213)	 WevtPow2Gen= EvtWeight *4.89983;
	 if(mWW > 213 && mWW <= 224)	 WevtPow2Gen= EvtWeight *13.4186;
	 if(mWW > 224 && mWW <= 235)	 WevtPow2Gen= EvtWeight *11.2554;
	 if(mWW > 235 && mWW <= 246)	 WevtPow2Gen= EvtWeight *1.88529;
	 if(mWW > 246 && mWW <= 257)	 WevtPow2Gen= EvtWeight *0.62867;
	 if(mWW > 257 && mWW <= 268)	 WevtPow2Gen= EvtWeight *4.48807;
	 if(mWW > 268 && mWW <= 279)	 WevtPow2Gen= EvtWeight *5.07422;
	 if(mWW > 279 && mWW <= 290)	 WevtPow2Gen= EvtWeight *4.59607;
	 if(mWW > 290 && mWW <= 301)	 WevtPow2Gen= EvtWeight *1.02572;
	 if(mWW > 301 && mWW <= 312)	 WevtPow2Gen= EvtWeight *1.27655;
	 if(mWW > 312 && mWW <= 323)	 WevtPow2Gen= EvtWeight *1.94722;
	 if(mWW > 323 && mWW <= 334)	 WevtPow2Gen= EvtWeight *3.8749;
	 if(mWW > 334 && mWW <= 345)	 WevtPow2Gen= EvtWeight *1.5976;
	 if(mWW > 345 && mWW <= 356)	 WevtPow2Gen= EvtWeight *1.22417;
	 if(mWW > 356 && mWW <= 367)	 WevtPow2Gen= EvtWeight *2.1317;
	 if(mWW > 367 && mWW <= 378)	 WevtPow2Gen= EvtWeight *4.50789;
	 if(mWW > 378 && mWW <= 389)	 WevtPow2Gen= EvtWeight *3.08041;
	 if(mWW > 389 && mWW <= 400)	 WevtPow2Gen= EvtWeight *2.70781;
	 if(mWW > 400 && mWW <= 411)	 WevtPow2Gen= EvtWeight *1.83711;
	 if(mWW > 411 && mWW <= 422)	 WevtPow2Gen= EvtWeight *3.56756;
	 if(mWW > 422 && mWW <= 433)	 WevtPow2Gen= EvtWeight *3.3422;
	 if(mWW > 433 && mWW <= 444)	 WevtPow2Gen= EvtWeight *4.40606;
	 if(mWW > 444 && mWW <= 455)	 WevtPow2Gen= EvtWeight *3.76388;
	 if(mWW > 455 && mWW <= 466)	 WevtPow2Gen= EvtWeight *3.31654;
	 if(mWW > 466 && mWW <= 477)	 WevtPow2Gen= EvtWeight *4.22044;
	 if(mWW > 477 && mWW <= 488)	 WevtPow2Gen= EvtWeight *4.36318;
	 if(mWW > 488 && mWW <= 499)	 WevtPow2Gen= EvtWeight *5.40865;
	 if(mWW > 499 && mWW <= 510)	 WevtPow2Gen= EvtWeight *3.88376;
	 if(mWW > 510 && mWW <= 521)	 WevtPow2Gen= EvtWeight *4.62527;
	 if(mWW > 521 && mWW <= 532)	 WevtPow2Gen= EvtWeight *5.173;
	 if(mWW > 532 && mWW <= 543)	 WevtPow2Gen= EvtWeight *5.99722;
	 if(mWW > 543 && mWW <= 554)	 WevtPow2Gen= EvtWeight *5.56273;
	 if(mWW > 554 && mWW <= 565)	 WevtPow2Gen= EvtWeight *5.67707;
	 if(mWW > 565 && mWW <= 576)	 WevtPow2Gen= EvtWeight *5.26314;
	 if(mWW > 576 && mWW <= 587)	 WevtPow2Gen= EvtWeight *5.95052;
	 if(mWW > 587 && mWW <= 598)	 WevtPow2Gen= EvtWeight *8.00447;
	 if(mWW > 598 && mWW <= 609)	 WevtPow2Gen= EvtWeight *5.70781;
	 if(mWW > 609 && mWW <= 620)	 WevtPow2Gen= EvtWeight *9.65859;
	 if(mWW > 620 && mWW <= 631)	 WevtPow2Gen= EvtWeight *11.9354;
	 if(mWW > 631 && mWW <= 642)	 WevtPow2Gen= EvtWeight *13.4702;
	 if(mWW > 642 && mWW <= 653)	 WevtPow2Gen= EvtWeight *11.6394;
	 if(mWW > 653 && mWW <= 664)	 WevtPow2Gen= EvtWeight *16.6219;
	 if(mWW > 664 && mWW <= 675)	 WevtPow2Gen= EvtWeight *13.4169;
	 if(mWW > 675 && mWW <= 686)	 WevtPow2Gen= EvtWeight *17.9348;
	 if(mWW > 686 && mWW <= 697)	 WevtPow2Gen= EvtWeight *15.1705;
	 if(mWW > 697 && mWW <= 708)	 WevtPow2Gen= EvtWeight *10.7668;
	 if(mWW > 708 && mWW <= 719)	 WevtPow2Gen= EvtWeight *14.6383;
	 if(mWW > 719 && mWW <= 730)	 WevtPow2Gen= EvtWeight *22.3761;
	 if(mWW > 730 && mWW <= 741)	 WevtPow2Gen= EvtWeight *20.4784;
	 if(mWW > 741 && mWW <= 752)	 WevtPow2Gen= EvtWeight *21.0087;
	 if(mWW > 752 && mWW <= 763)	 WevtPow2Gen= EvtWeight *18.3692;
	 if(mWW > 763 && mWW <= 774)	 WevtPow2Gen= EvtWeight *25.0529;
	 if(mWW > 774 && mWW <= 785)	 WevtPow2Gen= EvtWeight *25.4016;
	 if(mWW > 785 && mWW <= 796)	 WevtPow2Gen= EvtWeight *16.9541;
	 if(mWW > 796 && mWW <= 807)	 WevtPow2Gen= EvtWeight *25.6402;
	 if(mWW > 807 && mWW <= 818)	 WevtPow2Gen= EvtWeight *22.7752;
	 if(mWW > 818 && mWW <= 829)	 WevtPow2Gen= EvtWeight *28.1462;
	 if(mWW > 829 && mWW <= 840)	 WevtPow2Gen= EvtWeight *28.7354;
	 if(mWW > 840 && mWW <= 851)	 WevtPow2Gen= EvtWeight *24.8397;
	 if(mWW > 851 && mWW <= 862)	 WevtPow2Gen= EvtWeight *18.5197;
	 if(mWW > 862 && mWW <= 873)	 WevtPow2Gen= EvtWeight *38.104;
	 if(mWW > 873 && mWW <= 884)	 WevtPow2Gen= EvtWeight *39.8705;
	 if(mWW > 884 && mWW <= 895)	 WevtPow2Gen= EvtWeight *25.8078;
	 if(mWW > 895 && mWW <= 906)	 WevtPow2Gen= EvtWeight *45.0015;
	 if(mWW > 906 && mWW <= 917)	 WevtPow2Gen= EvtWeight *32.4242;
	 if(mWW > 917 && mWW <= 928)	 WevtPow2Gen= EvtWeight *34.0086;
	 if(mWW > 928 && mWW <= 939)	 WevtPow2Gen= EvtWeight *51.5417;
	 if(mWW > 939 && mWW <= 950)	 WevtPow2Gen= EvtWeight *47.0103;
	 if(mWW > 950 && mWW <= 961)	 WevtPow2Gen= EvtWeight *55.6439;
	 if(mWW > 961 && mWW <= 972)	 WevtPow2Gen= EvtWeight *58.0529;
	 if(mWW > 972 && mWW <= 983)	 WevtPow2Gen= EvtWeight *47.6098;
	 if(mWW > 983 && mWW <= 994)	 WevtPow2Gen= EvtWeight *46.9514;
	 if(mWW > 994 && mWW <= 1005)	 WevtPow2Gen= EvtWeight *60.3147;
	 if(mWW > 1005 && mWW <= 1016)	 WevtPow2Gen= EvtWeight *53.6876;
	 if(mWW > 1016 && mWW <= 1027)	 WevtPow2Gen= EvtWeight *63.6549;
	 if(mWW > 1027 && mWW <= 1038)	 WevtPow2Gen= EvtWeight *75.2765;
	 if(mWW > 1038 && mWW <= 1049)	 WevtPow2Gen= EvtWeight *52.2375;
	 if(mWW > 1049 && mWW <= 1060)	 WevtPow2Gen= EvtWeight *75.0484;
	 if(mWW > 1060 && mWW <= 1071)	 WevtPow2Gen= EvtWeight *76.1238;
	 if(mWW > 1071 && mWW <= 1082)	 WevtPow2Gen= EvtWeight *87.0888;
	 if(mWW > 1082 && mWW <= 1093)	 WevtPow2Gen= EvtWeight *96.1799;
	 if(mWW > 1093 && mWW <= 1104)	 WevtPow2Gen= EvtWeight *94.4927;
	 if(mWW > 1104 && mWW <= 1115)	 WevtPow2Gen= EvtWeight *99.8652;
	 if(mWW > 1115 && mWW <= 1126)	 WevtPow2Gen= EvtWeight *116.561;
	 if(mWW > 1126 && mWW <= 1137)	 WevtPow2Gen= EvtWeight *98.021;
	 if(mWW > 1137 && mWW <= 1148)	 WevtPow2Gen= EvtWeight *108.595;
	 if(mWW > 1148 && mWW <= 1159)	 WevtPow2Gen= EvtWeight *122.472;
	 if(mWW > 1159 && mWW <= 1170)	 WevtPow2Gen= EvtWeight *153.295;
	 if(mWW > 1170 && mWW <= 1181)	 WevtPow2Gen= EvtWeight *109.719;
	 if(mWW > 1181 && mWW <= 1192)	 WevtPow2Gen= EvtWeight *148.772;
	 if(mWW > 1192 && mWW <= 1203)	 WevtPow2Gen= EvtWeight *75.6838;
	 if(mWW > 1203 && mWW <= 1214)	 WevtPow2Gen= EvtWeight *161.836;
	 if(mWW > 1214 && mWW <= 1225)	 WevtPow2Gen= EvtWeight *165.264;
	 if(mWW > 1225 && mWW <= 1236)	 WevtPow2Gen= EvtWeight *130.031;
	 if(mWW > 1236 && mWW <= 1247)	 WevtPow2Gen= EvtWeight *213.356;
	 if(mWW > 1247 && mWW <= 1258)	 WevtPow2Gen= EvtWeight *135.756;
	 if(mWW > 1258 && mWW <= 1269)	 WevtPow2Gen= EvtWeight *179.621;
	 if(mWW > 1269 && mWW <= 1280)	 WevtPow2Gen= EvtWeight *225.079;
	 if(mWW > 1280 && mWW <= 1291)	 WevtPow2Gen= EvtWeight *202.797;
	 if(mWW > 1291 && mWW <= 1302)	 WevtPow2Gen= EvtWeight *130.015;
	 if(mWW > 1302 && mWW <= 1313)	 WevtPow2Gen= EvtWeight *128.639;
	 if(mWW > 1313 && mWW <= 1324)	 WevtPow2Gen= EvtWeight *202.465;
	 if(mWW > 1324 && mWW <= 1335)	 WevtPow2Gen= EvtWeight *182.231;
	 if(mWW > 1335 && mWW <= 1346)	 WevtPow2Gen= EvtWeight *204.898;
	 if(mWW > 1346 && mWW <= 1357)	 WevtPow2Gen= EvtWeight *380.65;
	 if(mWW > 1357 && mWW <= 1368)	 WevtPow2Gen= EvtWeight *344.026;
	 if(mWW > 1368 && mWW <= 1379)	 WevtPow2Gen= EvtWeight *295.276;
	 if(mWW > 1379 && mWW <= 1390)	 WevtPow2Gen= EvtWeight *375.854;
	 if(mWW > 1390 && mWW <= 1401)	 WevtPow2Gen= EvtWeight *332.21;
	 if(mWW > 1401 && mWW <= 1412)	 WevtPow2Gen= EvtWeight *126.05;
	 if(mWW > 1412 && mWW <= 1423)	 WevtPow2Gen= EvtWeight *413.078;
	 if(mWW > 1423 && mWW <= 1434)	 WevtPow2Gen= EvtWeight *418.315;
