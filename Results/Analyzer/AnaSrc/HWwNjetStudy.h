...
void HWwNjetStudy::Calc_Pow_Vbf_Weight()
{
	 ...
	 if(mWW > 130 && mWW <= 143)	 WevtPow2Gen= EvtWeight *0.0576041;
	 if(mWW > 143 && mWW <= 156)	 WevtPow2Gen= EvtWeight *0.0242197;
	 if(mWW > 156 && mWW <= 169)	 WevtPow2Gen= EvtWeight *0.305182;
	 if(mWW > 169 && mWW <= 182)	 WevtPow2Gen= EvtWeight *0.176513;
	 if(mWW > 182 && mWW <= 195)	 WevtPow2Gen= EvtWeight *0.392142;
	 if(mWW > 195 && mWW <= 208)	 WevtPow2Gen= EvtWeight *0.491586;
	 if(mWW > 208 && mWW <= 221)	 WevtPow2Gen= EvtWeight *12.2919;
	 if(mWW > 221 && mWW <= 234)	 WevtPow2Gen= EvtWeight *13.179;
	 if(mWW > 234 && mWW <= 247)	 WevtPow2Gen= EvtWeight *1.86428;
	 if(mWW > 247 && mWW <= 260)	 WevtPow2Gen= EvtWeight *0.652378;
	 if(mWW > 260 && mWW <= 273)	 WevtPow2Gen= EvtWeight *7.60949;
	 if(mWW > 273 && mWW <= 286)	 WevtPow2Gen= EvtWeight *4.39016;
	 if(mWW > 286 && mWW <= 299)	 WevtPow2Gen= EvtWeight *1.61062;
	 if(mWW > 299 && mWW <= 312)	 WevtPow2Gen= EvtWeight *1.17678;
	 if(mWW > 312 && mWW <= 325)	 WevtPow2Gen= EvtWeight *3.47518;
	 if(mWW > 325 && mWW <= 338)	 WevtPow2Gen= EvtWeight *2.55573;
	 if(mWW > 338 && mWW <= 351)	 WevtPow2Gen= EvtWeight *1.69598;
	 if(mWW > 351 && mWW <= 364)	 WevtPow2Gen= EvtWeight *1.41841;
	 if(mWW > 364 && mWW <= 377)	 WevtPow2Gen= EvtWeight *4.26832;
	 if(mWW > 377 && mWW <= 390)	 WevtPow2Gen= EvtWeight *3.34576;
	 if(mWW > 390 && mWW <= 403)	 WevtPow2Gen= EvtWeight *2.2948;
	 if(mWW > 403 && mWW <= 416)	 WevtPow2Gen= EvtWeight *2.01869;
	 if(mWW > 416 && mWW <= 429)	 WevtPow2Gen= EvtWeight *4.00108;
	 if(mWW > 429 && mWW <= 442)	 WevtPow2Gen= EvtWeight *3.41298;
	 if(mWW > 442 && mWW <= 455)	 WevtPow2Gen= EvtWeight *4.25006;
	 if(mWW > 455 && mWW <= 468)	 WevtPow2Gen= EvtWeight *3.42018;
	 if(mWW > 468 && mWW <= 481)	 WevtPow2Gen= EvtWeight *4.04834;
	 if(mWW > 481 && mWW <= 494)	 WevtPow2Gen= EvtWeight *4.67173;
	 if(mWW > 494 && mWW <= 507)	 WevtPow2Gen= EvtWeight *3.97392;
	 if(mWW > 507 && mWW <= 520)	 WevtPow2Gen= EvtWeight *3.7881;
	 if(mWW > 520 && mWW <= 533)	 WevtPow2Gen= EvtWeight *4.85367;
	 if(mWW > 533 && mWW <= 546)	 WevtPow2Gen= EvtWeight *5.78006;
	 if(mWW > 546 && mWW <= 559)	 WevtPow2Gen= EvtWeight *4.85446;
	 if(mWW > 559 && mWW <= 572)	 WevtPow2Gen= EvtWeight *4.25213;
	 if(mWW > 572 && mWW <= 585)	 WevtPow2Gen= EvtWeight *6.58343;
	 if(mWW > 585 && mWW <= 598)	 WevtPow2Gen= EvtWeight *6.42511;
	 if(mWW > 598 && mWW <= 611)	 WevtPow2Gen= EvtWeight *5.40672;
	 if(mWW > 611 && mWW <= 624)	 WevtPow2Gen= EvtWeight *8.7002;
	 if(mWW > 624 && mWW <= 637)	 WevtPow2Gen= EvtWeight *10.756;
	 if(mWW > 637 && mWW <= 650)	 WevtPow2Gen= EvtWeight *11.064;
	 if(mWW > 650 && mWW <= 663)	 WevtPow2Gen= EvtWeight *14.0309;
	 if(mWW > 663 && mWW <= 676)	 WevtPow2Gen= EvtWeight *11.9058;
	 if(mWW > 676 && mWW <= 689)	 WevtPow2Gen= EvtWeight *15.5507;
	 if(mWW > 689 && mWW <= 702)	 WevtPow2Gen= EvtWeight *11.8792;
	 if(mWW > 702 && mWW <= 715)	 WevtPow2Gen= EvtWeight *10.5687;
	 if(mWW > 715 && mWW <= 728)	 WevtPow2Gen= EvtWeight *19.5359;
	 if(mWW > 728 && mWW <= 741)	 WevtPow2Gen= EvtWeight *18.4165;
	 if(mWW > 741 && mWW <= 754)	 WevtPow2Gen= EvtWeight *18.4694;
	 if(mWW > 754 && mWW <= 767)	 WevtPow2Gen= EvtWeight *16.0639;
	 if(mWW > 767 && mWW <= 780)	 WevtPow2Gen= EvtWeight *23.3025;
	 if(mWW > 780 && mWW <= 793)	 WevtPow2Gen= EvtWeight *16.7484;
	 if(mWW > 793 && mWW <= 806)	 WevtPow2Gen= EvtWeight *19.9367;
	 if(mWW > 806 && mWW <= 819)	 WevtPow2Gen= EvtWeight *21.7226;
	 if(mWW > 819 && mWW <= 832)	 WevtPow2Gen= EvtWeight *25.6721;
	 if(mWW > 832 && mWW <= 845)	 WevtPow2Gen= EvtWeight *22.1767;
	 if(mWW > 845 && mWW <= 858)	 WevtPow2Gen= EvtWeight *21.6958;
	 if(mWW > 858 && mWW <= 871)	 WevtPow2Gen= EvtWeight *25.2752;
	 if(mWW > 871 && mWW <= 884)	 WevtPow2Gen= EvtWeight *36.0169;
	 if(mWW > 884 && mWW <= 897)	 WevtPow2Gen= EvtWeight *25.0824;
	 if(mWW > 897 && mWW <= 910)	 WevtPow2Gen= EvtWeight *33.9265;
	 if(mWW > 910 && mWW <= 923)	 WevtPow2Gen= EvtWeight *34.3126;
	 if(mWW > 923 && mWW <= 936)	 WevtPow2Gen= EvtWeight *36.8339;
	 if(mWW > 936 && mWW <= 949)	 WevtPow2Gen= EvtWeight *44.0222;
	 if(mWW > 949 && mWW <= 962)	 WevtPow2Gen= EvtWeight *49.6775;
	 if(mWW > 962 && mWW <= 975)	 WevtPow2Gen= EvtWeight *53.9233;
	 if(mWW > 975 && mWW <= 988)	 WevtPow2Gen= EvtWeight *47.482;
	 if(mWW > 988 && mWW <= 1001)	 WevtPow2Gen= EvtWeight *32.7874;
	 if(mWW > 1001 && mWW <= 1014)	 WevtPow2Gen= EvtWeight *60.1736;
	 if(mWW > 1014 && mWW <= 1027)	 WevtPow2Gen= EvtWeight *49.1944;
	 if(mWW > 1027 && mWW <= 1040)	 WevtPow2Gen= EvtWeight *62.4406;
	 if(mWW > 1040 && mWW <= 1053)	 WevtPow2Gen= EvtWeight *57.2968;
	 if(mWW > 1053 && mWW <= 1066)	 WevtPow2Gen= EvtWeight *62.9018;
	 if(mWW > 1066 && mWW <= 1079)	 WevtPow2Gen= EvtWeight *72.0919;
	 if(mWW > 1079 && mWW <= 1092)	 WevtPow2Gen= EvtWeight *88.2164;
	 if(mWW > 1092 && mWW <= 1105)	 WevtPow2Gen= EvtWeight *82.8549;
	 if(mWW > 1105 && mWW <= 1118)	 WevtPow2Gen= EvtWeight *96.0687;
	 if(mWW > 1118 && mWW <= 1131)	 WevtPow2Gen= EvtWeight *113.219;
	 if(mWW > 1131 && mWW <= 1144)	 WevtPow2Gen= EvtWeight *83.451;
	 if(mWW > 1144 && mWW <= 1157)	 WevtPow2Gen= EvtWeight *103.51;
	 if(mWW > 1157 && mWW <= 1170)	 WevtPow2Gen= EvtWeight *130.934;
	 if(mWW > 1170 && mWW <= 1183)	 WevtPow2Gen= EvtWeight *103.634;
	 if(mWW > 1183 && mWW <= 1196)	 WevtPow2Gen= EvtWeight *101.642;
	 if(mWW > 1196 && mWW <= 1209)	 WevtPow2Gen= EvtWeight *95.0483;
	 if(mWW > 1209 && mWW <= 1222)	 WevtPow2Gen= EvtWeight *143.029;
	 if(mWW > 1222 && mWW <= 1235)	 WevtPow2Gen= EvtWeight *151.606;
	 if(mWW > 1235 && mWW <= 1248)	 WevtPow2Gen= EvtWeight *174.481;
	 if(mWW > 1248 && mWW <= 1261)	 WevtPow2Gen= EvtWeight *113.824;
	 if(mWW > 1261 && mWW <= 1274)	 WevtPow2Gen= EvtWeight *138.504;
	 if(mWW > 1274 && mWW <= 1287)	 WevtPow2Gen= EvtWeight *243.15;
	 if(mWW > 1287 && mWW <= 1300)	 WevtPow2Gen= EvtWeight *119.773;
	 if(mWW > 1300 && mWW <= 1313)	 WevtPow2Gen= EvtWeight *141.117;
	 if(mWW > 1313 && mWW <= 1326)	 WevtPow2Gen= EvtWeight *174.731;
	 if(mWW > 1326 && mWW <= 1339)	 WevtPow2Gen= EvtWeight *191.189;
	 if(mWW > 1339 && mWW <= 1352)	 WevtPow2Gen= EvtWeight *253.168;
	 if(mWW > 1352 && mWW <= 1365)	 WevtPow2Gen= EvtWeight *279.638;
	 if(mWW > 1365 && mWW <= 1378)	 WevtPow2Gen= EvtWeight *337.494;
	 if(mWW > 1378 && mWW <= 1391)	 WevtPow2Gen= EvtWeight *276.355;
	 if(mWW > 1391 && mWW <= 1404)	 WevtPow2Gen= EvtWeight *246.517;
	 if(mWW > 1404 && mWW <= 1417)	 WevtPow2Gen= EvtWeight *263.279;
	 if(mWW > 1417 && mWW <= 1430)	 WevtPow2Gen= EvtWeight *321.985;
