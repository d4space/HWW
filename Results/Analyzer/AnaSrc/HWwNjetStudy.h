...
void HWwNjetStudy::Calc_Pow_Weight()
{
      ...
      if(mWW > 0 && mWW <= 10) EvtWeight *=0;
      if(mWW > 10 && mWW <= 20) EvtWeight *=0;
      if(mWW > 20 && mWW <= 30) EvtWeight *=0;
      if(mWW > 30 && mWW <= 40) EvtWeight *=0;
      if(mWW > 40 && mWW <= 50) EvtWeight *=0;
      if(mWW > 50 && mWW <= 60) EvtWeight *=0;
      if(mWW > 60 && mWW <= 70) EvtWeight *=0;
      if(mWW > 70 && mWW <= 80) EvtWeight *=0;
      if(mWW > 80 && mWW <= 90) EvtWeight *=0;
      if(mWW > 90 && mWW <= 100) EvtWeight *=0;
      if(mWW > 100 && mWW <= 110) EvtWeight *=0;
      if(mWW > 110 && mWW <= 120) EvtWeight *=0;
      if(mWW > 120 && mWW <= 130) EvtWeight *=0;
      if(mWW > 130 && mWW <= 140) EvtWeight *=0.00871699;
      if(mWW > 140 && mWW <= 150) EvtWeight *=0.0391272;
      if(mWW > 150 && mWW <= 160) EvtWeight *=0.0723458;
      if(mWW > 160 && mWW <= 170) EvtWeight *=0.649964;
      if(mWW > 170 && mWW <= 180) EvtWeight *=0.720722;
      if(mWW > 180 && mWW <= 190) EvtWeight *=0.707012;
      if(mWW > 190 && mWW <= 200) EvtWeight *=0.693216;
      if(mWW > 200 && mWW <= 210) EvtWeight *=1.25262;
      if(mWW > 210 && mWW <= 220) EvtWeight *=15.9138;
      if(mWW > 220 && mWW <= 230) EvtWeight *=13.7654;
      if(mWW > 230 && mWW <= 240) EvtWeight *=7.39984;
      if(mWW > 240 && mWW <= 250) EvtWeight *=0.953229;
      if(mWW > 250 && mWW <= 260) EvtWeight *=0.980323;
      if(mWW > 260 && mWW <= 270) EvtWeight *=5.40834;
      if(mWW > 270 && mWW <= 280) EvtWeight *=5.62522;
      if(mWW > 280 && mWW <= 290) EvtWeight *=3.68404;
      if(mWW > 290 && mWW <= 300) EvtWeight *=0.890208;
      if(mWW > 300 && mWW <= 310) EvtWeight *=0.841882;
      if(mWW > 310 && mWW <= 320) EvtWeight *=3.23824;
      if(mWW > 320 && mWW <= 330) EvtWeight *=3.45535;
      if(mWW > 330 && mWW <= 340) EvtWeight *=2.50329;
      if(mWW > 340 && mWW <= 350) EvtWeight *=1.06168;
      if(mWW > 350 && mWW <= 360) EvtWeight *=1.35149;
      if(mWW > 360 && mWW <= 370) EvtWeight *=2.79692;
      if(mWW > 370 && mWW <= 380) EvtWeight *=3.01155;
      if(mWW > 380 && mWW <= 390) EvtWeight *=2.28152;
      if(mWW > 390 && mWW <= 400) EvtWeight *=1.60051;
      if(mWW > 400 && mWW <= 410) EvtWeight *=1.70802;
      if(mWW > 410 && mWW <= 420) EvtWeight *=1.9983;
      if(mWW > 420 && mWW <= 430) EvtWeight *=1.88497;
      if(mWW > 430 && mWW <= 440) EvtWeight *=1.76916;
      if(mWW > 440 && mWW <= 450) EvtWeight *=1.45465;
      if(mWW > 450 && mWW <= 460) EvtWeight *=1.41584;
      if(mWW > 460 && mWW <= 470) EvtWeight *=1.47851;
      if(mWW > 470 && mWW <= 480) EvtWeight *=1.32527;
      if(mWW > 480 && mWW <= 490) EvtWeight *=1.20203;
      if(mWW > 490 && mWW <= 500) EvtWeight *=1.25154;
      if(mWW > 500 && mWW <= 510) EvtWeight *=1.06218;
      if(mWW > 510 && mWW <= 520) EvtWeight *=1.13095;
      if(mWW > 520 && mWW <= 530) EvtWeight *=1.02816;
      if(mWW > 530 && mWW <= 540) EvtWeight *=1.02411;
      if(mWW > 540 && mWW <= 550) EvtWeight *=0.954707;
      if(mWW > 550 && mWW <= 560) EvtWeight *=0.911937;
      if(mWW > 560 && mWW <= 570) EvtWeight *=0.879006;
      if(mWW > 570 && mWW <= 580) EvtWeight *=0.899559;
      if(mWW > 580 && mWW <= 590) EvtWeight *=0.838576;
      if(mWW > 590 && mWW <= 600) EvtWeight *=0.824297;
      if(mWW > 600 && mWW <= 610) EvtWeight *=0.843217;
      if(mWW > 610 && mWW <= 620) EvtWeight *=0.737646;
      if(mWW > 620 && mWW <= 630) EvtWeight *=0.762328;
      if(mWW > 630 && mWW <= 640) EvtWeight *=0.758078;
      if(mWW > 640 && mWW <= 650) EvtWeight *=0.751754;
      if(mWW > 650 && mWW <= 660) EvtWeight *=0.747746;
      if(mWW > 660 && mWW <= 670) EvtWeight *=0.768376;
      if(mWW > 670 && mWW <= 680) EvtWeight *=0.620122;
      if(mWW > 680 && mWW <= 690) EvtWeight *=0.549932;
      if(mWW > 690 && mWW <= 700) EvtWeight *=0.585932;
      if(mWW > 700 && mWW <= 710) EvtWeight *=0.619532;
      if(mWW > 710 && mWW <= 720) EvtWeight *=0.537067;
      if(mWW > 720 && mWW <= 730) EvtWeight *=0.508487;
      if(mWW > 730 && mWW <= 740) EvtWeight *=0.580183;
      if(mWW > 740 && mWW <= 750) EvtWeight *=0.368617;
      if(mWW > 750 && mWW <= 760) EvtWeight *=0.3828;
      if(mWW > 760 && mWW <= 770) EvtWeight *=0.46953;
      if(mWW > 770 && mWW <= 780) EvtWeight *=0.424297;
      if(mWW > 780 && mWW <= 790) EvtWeight *=0.354219;
      if(mWW > 790 && mWW <= 800) EvtWeight *=0.526072;
      if(mWW > 800 && mWW <= 810) EvtWeight *=0.305419;
      if(mWW > 810 && mWW <= 820) EvtWeight *=0.302856;
      if(mWW > 820 && mWW <= 830) EvtWeight *=0.376189;
      if(mWW > 830 && mWW <= 840) EvtWeight *=0.220793;
      if(mWW > 840 && mWW <= 850) EvtWeight *=0.292792;
      if(mWW > 850 && mWW <= 860) EvtWeight *=0.356956;
      if(mWW > 860 && mWW <= 870) EvtWeight *=0.271428;
      if(mWW > 870 && mWW <= 880) EvtWeight *=0.320612;
      if(mWW > 880 && mWW <= 890) EvtWeight *=0.31409;
      if(mWW > 890 && mWW <= 900) EvtWeight *=0.377782;
      if(mWW > 900 && mWW <= 910) EvtWeight *=0.419037;
      if(mWW > 910 && mWW <= 920) EvtWeight *=0.391583;
      if(mWW > 920 && mWW <= 930) EvtWeight *=0.369815;
      if(mWW > 930 && mWW <= 940) EvtWeight *=0.631649;
      if(mWW > 940 && mWW <= 950) EvtWeight *=0.353518;
      if(mWW > 950 && mWW <= 960) EvtWeight *=0.297328;
      if(mWW > 960 && mWW <= 970) EvtWeight *=0.253587;
      if(mWW > 970 && mWW <= 980) EvtWeight *=0.240532;
      if(mWW > 980 && mWW <= 990) EvtWeight *=0.411324;
      if(mWW > 990 && mWW <= 1000) EvtWeight *=0.352324;
      if(mWW > 1000 && mWW <= 1010) EvtWeight *=0.16923;
      if(mWW > 1010 && mWW <= 1020) EvtWeight *=0.385854;
      if(mWW > 1020 && mWW <= 1030) EvtWeight *=0.37666;
      if(mWW > 1030 && mWW <= 1040) EvtWeight *=0.200073;
      if(mWW > 1040 && mWW <= 1050) EvtWeight *=0.38321;
      if(mWW > 1050 && mWW <= 1060) EvtWeight *=0.412438;
      if(mWW > 1060 && mWW <= 1070) EvtWeight *=0.302722;
      if(mWW > 1070 && mWW <= 1080) EvtWeight *=0.519815;
      if(mWW > 1080 && mWW <= 1090) EvtWeight *=0.746246;
      if(mWW > 1090 && mWW <= 1100) EvtWeight *=0.305605;
      if(mWW > 1100 && mWW <= 1110) EvtWeight *=0.410582;
      if(mWW > 1110 && mWW <= 1120) EvtWeight *=0.557263;
      if(mWW > 1120 && mWW <= 1130) EvtWeight *=0.621289;
      if(mWW > 1130 && mWW <= 1140) EvtWeight *=0.270878;
      if(mWW > 1140 && mWW <= 1150) EvtWeight *=0.319248;
      if(mWW > 1150 && mWW <= 1160) EvtWeight *=0.36065;
      if(mWW > 1160 && mWW <= 1170) EvtWeight *=0.585887;
      if(mWW > 1170 && mWW <= 1180) EvtWeight *=0.389861;
      if(mWW > 1180 && mWW <= 1190) EvtWeight *=0.389861;
      if(mWW > 1190 && mWW <= 1200) EvtWeight *=0.134132;
      if(mWW > 1200 && mWW <= 1210) EvtWeight *=0.16295;
      if(mWW > 1210 && mWW <= 1220) EvtWeight *=0.17827;
      if(mWW > 1220 && mWW <= 1230) EvtWeight *=0.301192;
      if(mWW > 1230 && mWW <= 1240) EvtWeight *=0.182961;
      if(mWW > 1240 && mWW <= 1250) EvtWeight *=0.395404;
      if(mWW > 1250 && mWW <= 1260) EvtWeight *=0.220715;
      if(mWW > 1260 && mWW <= 1270) EvtWeight *=0.432281;
      if(mWW > 1270 && mWW <= 1280) EvtWeight *=0.691411;
      if(mWW > 1280 && mWW <= 1290) EvtWeight *=0.26072;
      if(mWW > 1290 && mWW <= 1300) EvtWeight *=0.703064;
      if(mWW > 1300 && mWW <= 1310) EvtWeight *=0.567553;
      if(mWW > 1310 && mWW <= 1320) EvtWeight *=0.300109;
      if(mWW > 1320 && mWW <= 1330) EvtWeight *=0.84273;
      if(mWW > 1330 && mWW <= 1340) EvtWeight *=0.591704;
      if(mWW > 1340 && mWW <= 1350) EvtWeight *=0;
      if(mWW > 1350 && mWW <= 1360) EvtWeight *=0;
      if(mWW > 1360 && mWW <= 1370) EvtWeight *=0.379229;
      if(mWW > 1370 && mWW <= 1380) EvtWeight *=0.502592;
      if(mWW > 1380 && mWW <= 1390) EvtWeight *=0.430053;
      if(mWW > 1390 && mWW <= 1400) EvtWeight *=0.490766;
      if(mWW > 1400 && mWW <= 1410) EvtWeight *=0.604567;
      if(mWW > 1410 && mWW <= 1420) EvtWeight *=0.579377;
      if(mWW > 1420 && mWW <= 1430) EvtWeight *=1.06962;
      if(mWW > 1430 && mWW <= 1440) EvtWeight *=0.772503;
      if(mWW > 1440 && mWW <= 1450) EvtWeight *=0.463502;
      if(mWW > 1450 && mWW <= 1460) EvtWeight *=0;
      if(mWW > 1460 && mWW <= 1470) EvtWeight *=0;
      if(mWW > 1470 && mWW <= 1480) EvtWeight *=0.707036;
