...
void HWwNjetStudy::Calc_Pow_Vbf_Weight()
{
	 ...
	 if(mWW <= 130 		)	 WevtPow2Gen= EvtWeight *0.0669722;
	 if(mWW > 130 && mWW <= 143)	 WevtPow2Gen= EvtWeight *0.0669722;
	 if(mWW > 143 && mWW <= 156)	 WevtPow2Gen= EvtWeight *0.0253417;
	 if(mWW > 156 && mWW <= 169)	 WevtPow2Gen= EvtWeight *0.310727;
	 if(mWW > 169 && mWW <= 182)	 WevtPow2Gen= EvtWeight *0.181036;
	 if(mWW > 182 && mWW <= 195)	 WevtPow2Gen= EvtWeight *0.381222;
	 if(mWW > 195 && mWW <= 208)	 WevtPow2Gen= EvtWeight *0.468942;
	 if(mWW > 208 && mWW <= 221)	 WevtPow2Gen= EvtWeight *13.648;
	 if(mWW > 221 && mWW <= 234)	 WevtPow2Gen= EvtWeight *11.9415;
	 if(mWW > 234 && mWW <= 247)	 WevtPow2Gen= EvtWeight *1.78531;
	 if(mWW > 247 && mWW <= 260)	 WevtPow2Gen= EvtWeight *0.74768;
	 if(mWW > 260 && mWW <= 273)	 WevtPow2Gen= EvtWeight *6.56062;
	 if(mWW > 273 && mWW <= 286)	 WevtPow2Gen= EvtWeight *3.05029;
	 if(mWW > 286 && mWW <= 299)	 WevtPow2Gen= EvtWeight *1.74424;
	 if(mWW > 299 && mWW <= 312)	 WevtPow2Gen= EvtWeight *1.1038;
	 if(mWW > 312 && mWW <= 325)	 WevtPow2Gen= EvtWeight *2.64109;
	 if(mWW > 325 && mWW <= 338)	 WevtPow2Gen= EvtWeight *2.42392;
	 if(mWW > 338 && mWW <= 351)	 WevtPow2Gen= EvtWeight *1.56887;
	 if(mWW > 351 && mWW <= 364)	 WevtPow2Gen= EvtWeight *1.52903;
	 if(mWW > 364 && mWW <= 377)	 WevtPow2Gen= EvtWeight *3.87736;
	 if(mWW > 377 && mWW <= 390)	 WevtPow2Gen= EvtWeight *3.11783;
	 if(mWW > 390 && mWW <= 403)	 WevtPow2Gen= EvtWeight *2.54315;
	 if(mWW > 403 && mWW <= 416)	 WevtPow2Gen= EvtWeight *1.95163;
	 if(mWW > 416 && mWW <= 429)	 WevtPow2Gen= EvtWeight *4.1278;
	 if(mWW > 429 && mWW <= 442)	 WevtPow2Gen= EvtWeight *3.63014;
	 if(mWW > 442 && mWW <= 455)	 WevtPow2Gen= EvtWeight *4.32567;
	 if(mWW > 455 && mWW <= 468)	 WevtPow2Gen= EvtWeight *3.28969;
	 if(mWW > 468 && mWW <= 481)	 WevtPow2Gen= EvtWeight *4.61618;
	 if(mWW > 481 && mWW <= 494)	 WevtPow2Gen= EvtWeight *5.01742;
	 if(mWW > 494 && mWW <= 507)	 WevtPow2Gen= EvtWeight *4.08086;
	 if(mWW > 507 && mWW <= 520)	 WevtPow2Gen= EvtWeight *4.16983;
	 if(mWW > 520 && mWW <= 533)	 WevtPow2Gen= EvtWeight *5.50887;
	 if(mWW > 533 && mWW <= 546)	 WevtPow2Gen= EvtWeight *6.6027;
	 if(mWW > 546 && mWW <= 559)	 WevtPow2Gen= EvtWeight *5.43222;
	 if(mWW > 559 && mWW <= 572)	 WevtPow2Gen= EvtWeight *4.41582;
	 if(mWW > 572 && mWW <= 585)	 WevtPow2Gen= EvtWeight *7.1124;
	 if(mWW > 585 && mWW <= 598)	 WevtPow2Gen= EvtWeight *7.34013;
	 if(mWW > 598 && mWW <= 611)	 WevtPow2Gen= EvtWeight *6.36334;
	 if(mWW > 611 && mWW <= 624)	 WevtPow2Gen= EvtWeight *10.4065;
	 if(mWW > 624 && mWW <= 637)	 WevtPow2Gen= EvtWeight *12.1683;
	 if(mWW > 637 && mWW <= 650)	 WevtPow2Gen= EvtWeight *12.5413;
	 if(mWW > 650 && mWW <= 663)	 WevtPow2Gen= EvtWeight *15.9215;
	 if(mWW > 663 && mWW <= 676)	 WevtPow2Gen= EvtWeight *14.119;
	 if(mWW > 676 && mWW <= 689)	 WevtPow2Gen= EvtWeight *17.2227;
	 if(mWW > 689 && mWW <= 702)	 WevtPow2Gen= EvtWeight *13.83;
	 if(mWW > 702 && mWW <= 715)	 WevtPow2Gen= EvtWeight *12.0294;
	 if(mWW > 715 && mWW <= 728)	 WevtPow2Gen= EvtWeight *22.1032;
	 if(mWW > 728 && mWW <= 741)	 WevtPow2Gen= EvtWeight *19.7997;
	 if(mWW > 741 && mWW <= 754)	 WevtPow2Gen= EvtWeight *21.8643;
	 if(mWW > 754 && mWW <= 767)	 WevtPow2Gen= EvtWeight *19.3796;
	 if(mWW > 767 && mWW <= 780)	 WevtPow2Gen= EvtWeight *26.6383;
	 if(mWW > 780 && mWW <= 793)	 WevtPow2Gen= EvtWeight *18.1712;
	 if(mWW > 793 && mWW <= 806)	 WevtPow2Gen= EvtWeight *24.1601;
	 if(mWW > 806 && mWW <= 819)	 WevtPow2Gen= EvtWeight *23.7917;
	 if(mWW > 819 && mWW <= 832)	 WevtPow2Gen= EvtWeight *29.9317;
	 if(mWW > 832 && mWW <= 845)	 WevtPow2Gen= EvtWeight *25.0471;
	 if(mWW > 845 && mWW <= 858)	 WevtPow2Gen= EvtWeight *24.142;
	 if(mWW > 858 && mWW <= 871)	 WevtPow2Gen= EvtWeight *28.492;
	 if(mWW > 871 && mWW <= 884)	 WevtPow2Gen= EvtWeight *41.8683;
	 if(mWW > 884 && mWW <= 897)	 WevtPow2Gen= EvtWeight *29.6576;
	 if(mWW > 897 && mWW <= 910)	 WevtPow2Gen= EvtWeight *38.5989;
	 if(mWW > 910 && mWW <= 923)	 WevtPow2Gen= EvtWeight *37.9395;
	 if(mWW > 923 && mWW <= 936)	 WevtPow2Gen= EvtWeight *40.1959;
	 if(mWW > 936 && mWW <= 949)	 WevtPow2Gen= EvtWeight *49.6298;
	 if(mWW > 949 && mWW <= 962)	 WevtPow2Gen= EvtWeight *56.9514;
	 if(mWW > 962 && mWW <= 975)	 WevtPow2Gen= EvtWeight *58.0562;
	 if(mWW > 975 && mWW <= 988)	 WevtPow2Gen= EvtWeight *52.2998;
	 if(mWW > 988 && mWW <= 1001)	 WevtPow2Gen= EvtWeight *38.6939;
	 if(mWW > 1001 && mWW <= 1014)	 WevtPow2Gen= EvtWeight *67.9218;
	 if(mWW > 1014 && mWW <= 1027)	 WevtPow2Gen= EvtWeight *58.0286;
	 if(mWW > 1027 && mWW <= 1040)	 WevtPow2Gen= EvtWeight *69.9781;
	 if(mWW > 1040 && mWW <= 1053)	 WevtPow2Gen= EvtWeight *66.9752;
	 if(mWW > 1053 && mWW <= 1066)	 WevtPow2Gen= EvtWeight *69.2908;
	 if(mWW > 1066 && mWW <= 1079)	 WevtPow2Gen= EvtWeight *81.7423;
	 if(mWW > 1079 && mWW <= 1092)	 WevtPow2Gen= EvtWeight *99.1597;
	 if(mWW > 1092 && mWW <= 1105)	 WevtPow2Gen= EvtWeight *97.6035;
	 if(mWW > 1105 && mWW <= 1118)	 WevtPow2Gen= EvtWeight *97.3618;
	 if(mWW > 1118 && mWW <= 1131)	 WevtPow2Gen= EvtWeight *123.427;
	 if(mWW > 1131 && mWW <= 1144)	 WevtPow2Gen= EvtWeight *93.7366;
	 if(mWW > 1144 && mWW <= 1157)	 WevtPow2Gen= EvtWeight *122.255;
	 if(mWW > 1157 && mWW <= 1170)	 WevtPow2Gen= EvtWeight *146.911;
	 if(mWW > 1170 && mWW <= 1183)	 WevtPow2Gen= EvtWeight *117.07;
	 if(mWW > 1183 && mWW <= 1196)	 WevtPow2Gen= EvtWeight *123.355;
	 if(mWW > 1196 && mWW <= 1209)	 WevtPow2Gen= EvtWeight *103.244;
	 if(mWW > 1209 && mWW <= 1222)	 WevtPow2Gen= EvtWeight *172.81;
	 if(mWW > 1222 && mWW <= 1235)	 WevtPow2Gen= EvtWeight *149.463;
	 if(mWW > 1235 && mWW <= 1248)	 WevtPow2Gen= EvtWeight *204.556;
	 if(mWW > 1248 && mWW <= 1261)	 WevtPow2Gen= EvtWeight *135.957;
	 if(mWW > 1261 && mWW <= 1274)	 WevtPow2Gen= EvtWeight *158.143;
	 if(mWW > 1274 && mWW <= 1287)	 WevtPow2Gen= EvtWeight *283.185;
	 if(mWW > 1287 && mWW <= 1300)	 WevtPow2Gen= EvtWeight *128.325;
	 if(mWW > 1300 && mWW <= 1313)	 WevtPow2Gen= EvtWeight *145.518;
	 if(mWW > 1313 && mWW <= 1326)	 WevtPow2Gen= EvtWeight *198.765;
	 if(mWW > 1326 && mWW <= 1339)	 WevtPow2Gen= EvtWeight *203.44;
	 if(mWW > 1339 && mWW <= 1352)	 WevtPow2Gen= EvtWeight *299.21;
	 if(mWW > 1352 && mWW <= 1365)	 WevtPow2Gen= EvtWeight *299.72;
	 if(mWW > 1365 && mWW <= 1378)	 WevtPow2Gen= EvtWeight *369.272;
	 if(mWW > 1378 && mWW <= 1391)	 WevtPow2Gen= EvtWeight *305.069;
	 if(mWW > 1391 && mWW <= 1404)	 WevtPow2Gen= EvtWeight *281.493;
	 if(mWW > 1404 && mWW <= 1417)	 WevtPow2Gen= EvtWeight *305.584;
	 if(mWW > 1417 && mWW <= 1430)	 WevtPow2Gen= EvtWeight *360.381;
