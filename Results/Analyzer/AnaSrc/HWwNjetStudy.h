...
void HWwNjetStudy::Calc_Pow_Vbf_Weight()
{
	 ...
	 if(mWW > 130 && mWW <= 143)	 WevtPow2Gen= EvtWeight *0.0661003;
	 if(mWW > 143 && mWW <= 156)	 WevtPow2Gen= EvtWeight *0.0251346;
	 if(mWW > 156 && mWW <= 169)	 WevtPow2Gen= EvtWeight *0.30357;
	 if(mWW > 169 && mWW <= 182)	 WevtPow2Gen= EvtWeight *0.181167;
	 if(mWW > 182 && mWW <= 195)	 WevtPow2Gen= EvtWeight *0.396007;
	 if(mWW > 195 && mWW <= 208)	 WevtPow2Gen= EvtWeight *0.469954;
	 if(mWW > 208 && mWW <= 221)	 WevtPow2Gen= EvtWeight *13.5944;
	 if(mWW > 221 && mWW <= 234)	 WevtPow2Gen= EvtWeight *11.6732;
	 if(mWW > 234 && mWW <= 247)	 WevtPow2Gen= EvtWeight *1.68641;
	 if(mWW > 247 && mWW <= 260)	 WevtPow2Gen= EvtWeight *0.757286;
	 if(mWW > 260 && mWW <= 273)	 WevtPow2Gen= EvtWeight *7.09702;
	 if(mWW > 273 && mWW <= 286)	 WevtPow2Gen= EvtWeight *3.59302;
	 if(mWW > 286 && mWW <= 299)	 WevtPow2Gen= EvtWeight *1.72409;
	 if(mWW > 299 && mWW <= 312)	 WevtPow2Gen= EvtWeight *1.02605;
	 if(mWW > 312 && mWW <= 325)	 WevtPow2Gen= EvtWeight *3.10168;
	 if(mWW > 325 && mWW <= 338)	 WevtPow2Gen= EvtWeight *2.46252;
	 if(mWW > 338 && mWW <= 351)	 WevtPow2Gen= EvtWeight *1.55373;
	 if(mWW > 351 && mWW <= 364)	 WevtPow2Gen= EvtWeight *1.51222;
	 if(mWW > 364 && mWW <= 377)	 WevtPow2Gen= EvtWeight *3.65585;
	 if(mWW > 377 && mWW <= 390)	 WevtPow2Gen= EvtWeight *3.08781;
	 if(mWW > 390 && mWW <= 403)	 WevtPow2Gen= EvtWeight *2.46368;
	 if(mWW > 403 && mWW <= 416)	 WevtPow2Gen= EvtWeight *2.09366;
	 if(mWW > 416 && mWW <= 429)	 WevtPow2Gen= EvtWeight *4.07699;
	 if(mWW > 429 && mWW <= 442)	 WevtPow2Gen= EvtWeight *3.58946;
	 if(mWW > 442 && mWW <= 455)	 WevtPow2Gen= EvtWeight *4.15587;
	 if(mWW > 455 && mWW <= 468)	 WevtPow2Gen= EvtWeight *3.51098;
	 if(mWW > 468 && mWW <= 481)	 WevtPow2Gen= EvtWeight *4.41008;
	 if(mWW > 481 && mWW <= 494)	 WevtPow2Gen= EvtWeight *5.01838;
	 if(mWW > 494 && mWW <= 507)	 WevtPow2Gen= EvtWeight *4.44265;
	 if(mWW > 507 && mWW <= 520)	 WevtPow2Gen= EvtWeight *4.1838;
	 if(mWW > 520 && mWW <= 533)	 WevtPow2Gen= EvtWeight *5.38266;
	 if(mWW > 533 && mWW <= 546)	 WevtPow2Gen= EvtWeight *6.33873;
	 if(mWW > 546 && mWW <= 559)	 WevtPow2Gen= EvtWeight *5.56104;
	 if(mWW > 559 && mWW <= 572)	 WevtPow2Gen= EvtWeight *4.88843;
	 if(mWW > 572 && mWW <= 585)	 WevtPow2Gen= EvtWeight *7.40188;
	 if(mWW > 585 && mWW <= 598)	 WevtPow2Gen= EvtWeight *7.44981;
	 if(mWW > 598 && mWW <= 611)	 WevtPow2Gen= EvtWeight *6.24959;
	 if(mWW > 611 && mWW <= 624)	 WevtPow2Gen= EvtWeight *9.94351;
	 if(mWW > 624 && mWW <= 637)	 WevtPow2Gen= EvtWeight *12.0957;
	 if(mWW > 637 && mWW <= 650)	 WevtPow2Gen= EvtWeight *12.6573;
	 if(mWW > 650 && mWW <= 663)	 WevtPow2Gen= EvtWeight *15.9861;
	 if(mWW > 663 && mWW <= 676)	 WevtPow2Gen= EvtWeight *13.2997;
	 if(mWW > 676 && mWW <= 689)	 WevtPow2Gen= EvtWeight *17.1411;
	 if(mWW > 689 && mWW <= 702)	 WevtPow2Gen= EvtWeight *13.6146;
	 if(mWW > 702 && mWW <= 715)	 WevtPow2Gen= EvtWeight *11.3969;
	 if(mWW > 715 && mWW <= 728)	 WevtPow2Gen= EvtWeight *22.5768;
	 if(mWW > 728 && mWW <= 741)	 WevtPow2Gen= EvtWeight *20.5114;
	 if(mWW > 741 && mWW <= 754)	 WevtPow2Gen= EvtWeight *21.5141;
	 if(mWW > 754 && mWW <= 767)	 WevtPow2Gen= EvtWeight *18.148;
	 if(mWW > 767 && mWW <= 780)	 WevtPow2Gen= EvtWeight *25.2293;
	 if(mWW > 780 && mWW <= 793)	 WevtPow2Gen= EvtWeight *18.7134;
	 if(mWW > 793 && mWW <= 806)	 WevtPow2Gen= EvtWeight *22.9369;
	 if(mWW > 806 && mWW <= 819)	 WevtPow2Gen= EvtWeight *23.8349;
	 if(mWW > 819 && mWW <= 832)	 WevtPow2Gen= EvtWeight *29.4251;
	 if(mWW > 832 && mWW <= 845)	 WevtPow2Gen= EvtWeight *24.8475;
	 if(mWW > 845 && mWW <= 858)	 WevtPow2Gen= EvtWeight *24.8568;
	 if(mWW > 858 && mWW <= 871)	 WevtPow2Gen= EvtWeight *29.0223;
	 if(mWW > 871 && mWW <= 884)	 WevtPow2Gen= EvtWeight *41.1259;
	 if(mWW > 884 && mWW <= 897)	 WevtPow2Gen= EvtWeight *28.9287;
	 if(mWW > 897 && mWW <= 910)	 WevtPow2Gen= EvtWeight *39.4271;
	 if(mWW > 910 && mWW <= 923)	 WevtPow2Gen= EvtWeight *38.3484;
	 if(mWW > 923 && mWW <= 936)	 WevtPow2Gen= EvtWeight *41.3138;
	 if(mWW > 936 && mWW <= 949)	 WevtPow2Gen= EvtWeight *50.1856;
	 if(mWW > 949 && mWW <= 962)	 WevtPow2Gen= EvtWeight *56.2881;
	 if(mWW > 962 && mWW <= 975)	 WevtPow2Gen= EvtWeight *60.0695;
	 if(mWW > 975 && mWW <= 988)	 WevtPow2Gen= EvtWeight *54.1941;
	 if(mWW > 988 && mWW <= 1001)	 WevtPow2Gen= EvtWeight *37.9486;
	 if(mWW > 1001 && mWW <= 1014)	 WevtPow2Gen= EvtWeight *66.3424;
	 if(mWW > 1014 && mWW <= 1027)	 WevtPow2Gen= EvtWeight *56.4408;
	 if(mWW > 1027 && mWW <= 1040)	 WevtPow2Gen= EvtWeight *70.2849;
	 if(mWW > 1040 && mWW <= 1053)	 WevtPow2Gen= EvtWeight *67.1989;
	 if(mWW > 1053 && mWW <= 1066)	 WevtPow2Gen= EvtWeight *69.5163;
	 if(mWW > 1066 && mWW <= 1079)	 WevtPow2Gen= EvtWeight *80.647;
	 if(mWW > 1079 && mWW <= 1092)	 WevtPow2Gen= EvtWeight *98.1939;
	 if(mWW > 1092 && mWW <= 1105)	 WevtPow2Gen= EvtWeight *93.365;
	 if(mWW > 1105 && mWW <= 1118)	 WevtPow2Gen= EvtWeight *104.319;
	 if(mWW > 1118 && mWW <= 1131)	 WevtPow2Gen= EvtWeight *126.528;
	 if(mWW > 1131 && mWW <= 1144)	 WevtPow2Gen= EvtWeight *91.181;
	 if(mWW > 1144 && mWW <= 1157)	 WevtPow2Gen= EvtWeight *118.407;
	 if(mWW > 1157 && mWW <= 1170)	 WevtPow2Gen= EvtWeight *138.83;
	 if(mWW > 1170 && mWW <= 1183)	 WevtPow2Gen= EvtWeight *116.65;
	 if(mWW > 1183 && mWW <= 1196)	 WevtPow2Gen= EvtWeight *112.88;
	 if(mWW > 1196 && mWW <= 1209)	 WevtPow2Gen= EvtWeight *106.426;
	 if(mWW > 1209 && mWW <= 1222)	 WevtPow2Gen= EvtWeight *166.622;
	 if(mWW > 1222 && mWW <= 1235)	 WevtPow2Gen= EvtWeight *161.303;
	 if(mWW > 1235 && mWW <= 1248)	 WevtPow2Gen= EvtWeight *197.088;
	 if(mWW > 1248 && mWW <= 1261)	 WevtPow2Gen= EvtWeight *131.666;
	 if(mWW > 1261 && mWW <= 1274)	 WevtPow2Gen= EvtWeight *159.252;
	 if(mWW > 1274 && mWW <= 1287)	 WevtPow2Gen= EvtWeight *274.941;
	 if(mWW > 1287 && mWW <= 1300)	 WevtPow2Gen= EvtWeight *145.589;
	 if(mWW > 1300 && mWW <= 1313)	 WevtPow2Gen= EvtWeight *163.869;
	 if(mWW > 1313 && mWW <= 1326)	 WevtPow2Gen= EvtWeight *196.197;
	 if(mWW > 1326 && mWW <= 1339)	 WevtPow2Gen= EvtWeight *208.932;
	 if(mWW > 1339 && mWW <= 1352)	 WevtPow2Gen= EvtWeight *293.168;
	 if(mWW > 1352 && mWW <= 1365)	 WevtPow2Gen= EvtWeight *302.047;
	 if(mWW > 1365 && mWW <= 1378)	 WevtPow2Gen= EvtWeight *384.162;
	 if(mWW > 1378 && mWW <= 1391)	 WevtPow2Gen= EvtWeight *296.525;
	 if(mWW > 1391 && mWW <= 1404)	 WevtPow2Gen= EvtWeight *275.651;
	 if(mWW > 1404 && mWW <= 1417)	 WevtPow2Gen= EvtWeight *312.597;
	 if(mWW > 1417 && mWW <= 1430)	 WevtPow2Gen= EvtWeight *363.441;
