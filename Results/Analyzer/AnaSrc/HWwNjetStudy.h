...
void HWwNjetStudy::Calc_Pow_Vbf_Weight()
{
	 ...
	 if(mWW > 130 && mWW <= 143)	 WevtPow2Gen= EvtWeight *0.0701604;
	 if(mWW > 143 && mWW <= 156)	 WevtPow2Gen= EvtWeight *0.0279375;
	 if(mWW > 156 && mWW <= 169)	 WevtPow2Gen= EvtWeight *0.321637;
	 if(mWW > 169 && mWW <= 182)	 WevtPow2Gen= EvtWeight *0.219683;
	 if(mWW > 182 && mWW <= 195)	 WevtPow2Gen= EvtWeight *0.550567;
	 if(mWW > 195 && mWW <= 208)	 WevtPow2Gen= EvtWeight *0.632781;
	 if(mWW > 208 && mWW <= 221)	 WevtPow2Gen= EvtWeight *17.9722;
	 if(mWW > 221 && mWW <= 234)	 WevtPow2Gen= EvtWeight *15.6792;
	 if(mWW > 234 && mWW <= 247)	 WevtPow2Gen= EvtWeight *3.07872;
	 if(mWW > 247 && mWW <= 260)	 WevtPow2Gen= EvtWeight *0.937292;
	 if(mWW > 260 && mWW <= 273)	 WevtPow2Gen= EvtWeight *9.64233;
	 if(mWW > 273 && mWW <= 286)	 WevtPow2Gen= EvtWeight *7.10299;
	 if(mWW > 286 && mWW <= 299)	 WevtPow2Gen= EvtWeight *1.89483;
	 if(mWW > 299 && mWW <= 312)	 WevtPow2Gen= EvtWeight *1.39148;
	 if(mWW > 312 && mWW <= 325)	 WevtPow2Gen= EvtWeight *5.02561;
	 if(mWW > 325 && mWW <= 338)	 WevtPow2Gen= EvtWeight *4.56391;
	 if(mWW > 338 && mWW <= 351)	 WevtPow2Gen= EvtWeight *1.97189;
	 if(mWW > 351 && mWW <= 364)	 WevtPow2Gen= EvtWeight *1.96695;
	 if(mWW > 364 && mWW <= 377)	 WevtPow2Gen= EvtWeight *4.63495;
	 if(mWW > 377 && mWW <= 390)	 WevtPow2Gen= EvtWeight *3.00477;
	 if(mWW > 390 && mWW <= 403)	 WevtPow2Gen= EvtWeight *2.39865;
	 if(mWW > 403 && mWW <= 416)	 WevtPow2Gen= EvtWeight *2.69272;
	 if(mWW > 416 && mWW <= 429)	 WevtPow2Gen= EvtWeight *3.29524;
	 if(mWW > 429 && mWW <= 442)	 WevtPow2Gen= EvtWeight *3.34036;
	 if(mWW > 442 && mWW <= 455)	 WevtPow2Gen= EvtWeight *3.39638;
	 if(mWW > 455 && mWW <= 468)	 WevtPow2Gen= EvtWeight *3.62331;
	 if(mWW > 468 && mWW <= 481)	 WevtPow2Gen= EvtWeight *3.85894;
	 if(mWW > 481 && mWW <= 494)	 WevtPow2Gen= EvtWeight *3.86833;
	 if(mWW > 494 && mWW <= 507)	 WevtPow2Gen= EvtWeight *3.89776;
	 if(mWW > 507 && mWW <= 520)	 WevtPow2Gen= EvtWeight *4.21634;
	 if(mWW > 520 && mWW <= 533)	 WevtPow2Gen= EvtWeight *3.79578;
	 if(mWW > 533 && mWW <= 546)	 WevtPow2Gen= EvtWeight *4.81102;
	 if(mWW > 546 && mWW <= 559)	 WevtPow2Gen= EvtWeight *4.25353;
	 if(mWW > 559 && mWW <= 572)	 WevtPow2Gen= EvtWeight *3.73031;
	 if(mWW > 572 && mWW <= 585)	 WevtPow2Gen= EvtWeight *6.27795;
	 if(mWW > 585 && mWW <= 598)	 WevtPow2Gen= EvtWeight *5.86801;
	 if(mWW > 598 && mWW <= 611)	 WevtPow2Gen= EvtWeight *5.5655;
	 if(mWW > 611 && mWW <= 624)	 WevtPow2Gen= EvtWeight *7.64026;
	 if(mWW > 624 && mWW <= 637)	 WevtPow2Gen= EvtWeight *10.3323;
	 if(mWW > 637 && mWW <= 650)	 WevtPow2Gen= EvtWeight *7.85079;
	 if(mWW > 650 && mWW <= 663)	 WevtPow2Gen= EvtWeight *10.8438;
	 if(mWW > 663 && mWW <= 676)	 WevtPow2Gen= EvtWeight *8.87413;
	 if(mWW > 676 && mWW <= 689)	 WevtPow2Gen= EvtWeight *11.3259;
	 if(mWW > 689 && mWW <= 702)	 WevtPow2Gen= EvtWeight *10.73;
	 if(mWW > 702 && mWW <= 715)	 WevtPow2Gen= EvtWeight *8.49218;
	 if(mWW > 715 && mWW <= 728)	 WevtPow2Gen= EvtWeight *13.8907;
	 if(mWW > 728 && mWW <= 741)	 WevtPow2Gen= EvtWeight *16.8379;
	 if(mWW > 741 && mWW <= 754)	 WevtPow2Gen= EvtWeight *14.7397;
	 if(mWW > 754 && mWW <= 767)	 WevtPow2Gen= EvtWeight *13.7533;
	 if(mWW > 767 && mWW <= 780)	 WevtPow2Gen= EvtWeight *15.9655;
	 if(mWW > 780 && mWW <= 793)	 WevtPow2Gen= EvtWeight *14.5293;
	 if(mWW > 793 && mWW <= 806)	 WevtPow2Gen= EvtWeight *18.5659;
	 if(mWW > 806 && mWW <= 819)	 WevtPow2Gen= EvtWeight *17.3384;
	 if(mWW > 819 && mWW <= 832)	 WevtPow2Gen= EvtWeight *17.4951;
	 if(mWW > 832 && mWW <= 845)	 WevtPow2Gen= EvtWeight *13.0846;
	 if(mWW > 845 && mWW <= 858)	 WevtPow2Gen= EvtWeight *14.4739;
	 if(mWW > 858 && mWW <= 871)	 WevtPow2Gen= EvtWeight *20.5752;
	 if(mWW > 871 && mWW <= 884)	 WevtPow2Gen= EvtWeight *22.5159;
	 if(mWW > 884 && mWW <= 897)	 WevtPow2Gen= EvtWeight *23.9386;
	 if(mWW > 897 && mWW <= 910)	 WevtPow2Gen= EvtWeight *25.0516;
	 if(mWW > 910 && mWW <= 923)	 WevtPow2Gen= EvtWeight *26.2179;
	 if(mWW > 923 && mWW <= 936)	 WevtPow2Gen= EvtWeight *24.7799;
	 if(mWW > 936 && mWW <= 949)	 WevtPow2Gen= EvtWeight *27.0468;
	 if(mWW > 949 && mWW <= 962)	 WevtPow2Gen= EvtWeight *33.5025;
	 if(mWW > 962 && mWW <= 975)	 WevtPow2Gen= EvtWeight *40.0886;
	 if(mWW > 975 && mWW <= 988)	 WevtPow2Gen= EvtWeight *34.0457;
	 if(mWW > 988 && mWW <= 1001)	 WevtPow2Gen= EvtWeight *28.4315;
	 if(mWW > 1001 && mWW <= 1014)	 WevtPow2Gen= EvtWeight *45.0914;
	 if(mWW > 1014 && mWW <= 1027)	 WevtPow2Gen= EvtWeight *31.3611;
	 if(mWW > 1027 && mWW <= 1040)	 WevtPow2Gen= EvtWeight *39.2216;
	 if(mWW > 1040 && mWW <= 1053)	 WevtPow2Gen= EvtWeight *41.7611;
	 if(mWW > 1053 && mWW <= 1066)	 WevtPow2Gen= EvtWeight *43.9299;
	 if(mWW > 1066 && mWW <= 1079)	 WevtPow2Gen= EvtWeight *46.4725;
	 if(mWW > 1079 && mWW <= 1092)	 WevtPow2Gen= EvtWeight *50.2634;
	 if(mWW > 1092 && mWW <= 1105)	 WevtPow2Gen= EvtWeight *46.9682;
	 if(mWW > 1105 && mWW <= 1118)	 WevtPow2Gen= EvtWeight *63.6001;
	 if(mWW > 1118 && mWW <= 1131)	 WevtPow2Gen= EvtWeight *75.0404;
	 if(mWW > 1131 && mWW <= 1144)	 WevtPow2Gen= EvtWeight *61.7224;
	 if(mWW > 1144 && mWW <= 1157)	 WevtPow2Gen= EvtWeight *83.6816;
	 if(mWW > 1157 && mWW <= 1170)	 WevtPow2Gen= EvtWeight *84.4199;
	 if(mWW > 1170 && mWW <= 1183)	 WevtPow2Gen= EvtWeight *60.7399;
	 if(mWW > 1183 && mWW <= 1196)	 WevtPow2Gen= EvtWeight *90.0846;
	 if(mWW > 1196 && mWW <= 1209)	 WevtPow2Gen= EvtWeight *51.3282;
	 if(mWW > 1209 && mWW <= 1222)	 WevtPow2Gen= EvtWeight *108.836;
	 if(mWW > 1222 && mWW <= 1235)	 WevtPow2Gen= EvtWeight *102.173;
	 if(mWW > 1235 && mWW <= 1248)	 WevtPow2Gen= EvtWeight *98.2787;
	 if(mWW > 1248 && mWW <= 1261)	 WevtPow2Gen= EvtWeight *66.3916;
	 if(mWW > 1261 && mWW <= 1274)	 WevtPow2Gen= EvtWeight *80.0402;
	 if(mWW > 1274 && mWW <= 1287)	 WevtPow2Gen= EvtWeight *159.008;
	 if(mWW > 1287 && mWW <= 1300)	 WevtPow2Gen= EvtWeight *101.489;
	 if(mWW > 1300 && mWW <= 1313)	 WevtPow2Gen= EvtWeight *65.7494;
	 if(mWW > 1313 && mWW <= 1326)	 WevtPow2Gen= EvtWeight *100.53;
	 if(mWW > 1326 && mWW <= 1339)	 WevtPow2Gen= EvtWeight *134.916;
	 if(mWW > 1339 && mWW <= 1352)	 WevtPow2Gen= EvtWeight *144.66;
	 if(mWW > 1352 && mWW <= 1365)	 WevtPow2Gen= EvtWeight *185.687;
	 if(mWW > 1365 && mWW <= 1378)	 WevtPow2Gen= EvtWeight *196.055;
	 if(mWW > 1378 && mWW <= 1391)	 WevtPow2Gen= EvtWeight *133.605;
	 if(mWW > 1391 && mWW <= 1404)	 WevtPow2Gen= EvtWeight *205.279;
	 if(mWW > 1404 && mWW <= 1417)	 WevtPow2Gen= EvtWeight *164.423;
	 if(mWW > 1417 && mWW <= 1430)	 WevtPow2Gen= EvtWeight *199.448;
