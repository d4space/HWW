...
void HWwNjetStudy::Loop()
{
  ...
  for (int i(0); i<Ntries;i++)
  {
    ...
    if(SampleName == "POWHEG_VBF")
    {
      ...
      //
      //if(             mWW <= 140)  WevtPow2Gen= EvtWeight *0;
      //if(mWW > 140 && mWW <= 150)  WevtPow2Gen= EvtWeight *0.0517351;
      //if(mWW > 150 && mWW <= 160)  WevtPow2Gen= EvtWeight *0.0293496;
      //if(mWW > 160 && mWW <= 170)  WevtPow2Gen= EvtWeight *0.0310171;
      //if(mWW > 170 && mWW <= 180)  WevtPow2Gen= EvtWeight *0.287056;
      //if(mWW > 180 && mWW <= 190)  WevtPow2Gen= EvtWeight *0.246655;
      //if(mWW > 190 && mWW <= 200)  WevtPow2Gen= EvtWeight *0.246629;
      //if(mWW > 200 && mWW <= 210)  WevtPow2Gen= EvtWeight *0.291941;
      //if(mWW > 210 && mWW <= 220)  WevtPow2Gen= EvtWeight *1.06762;
      //if(mWW > 220 && mWW <= 230)  WevtPow2Gen= EvtWeight *13.2937;
      //if(mWW > 230 && mWW <= 240)  WevtPow2Gen= EvtWeight *14.8329;
      //if(mWW > 240 && mWW <= 250)  WevtPow2Gen= EvtWeight *8.31437;
      //if(mWW > 250 && mWW <= 260)  WevtPow2Gen= EvtWeight *0.717696;
      //if(mWW > 260 && mWW <= 270)  WevtPow2Gen= EvtWeight *0.879553;
      //if(mWW > 270 && mWW <= 280)  WevtPow2Gen= EvtWeight *6.36702;
      //if(mWW > 280 && mWW <= 290)  WevtPow2Gen= EvtWeight *5.22555;
      //if(mWW > 290 && mWW <= 300)  WevtPow2Gen= EvtWeight *3.90511;
      //if(mWW > 300 && mWW <= 310)  WevtPow2Gen= EvtWeight *0.909471;
      //if(mWW > 310 && mWW <= 320)  WevtPow2Gen= EvtWeight *1.29004;
      //if(mWW > 320 && mWW <= 330)  WevtPow2Gen= EvtWeight *3.91666;
      //if(mWW > 330 && mWW <= 340)  WevtPow2Gen= EvtWeight *3.20081;
      //if(mWW > 340 && mWW <= 350)  WevtPow2Gen= EvtWeight *2.84452;
      //if(mWW > 350 && mWW <= 360)  WevtPow2Gen= EvtWeight *1.46411;
      //if(mWW > 360 && mWW <= 370)  WevtPow2Gen= EvtWeight *0.974582;
      //if(mWW > 370 && mWW <= 380)  WevtPow2Gen= EvtWeight *2.67207;
      //if(mWW > 380 && mWW <= 390)  WevtPow2Gen= EvtWeight *5.75782;
      //if(mWW > 390 && mWW <= 400)  WevtPow2Gen= EvtWeight *3.4583;
      //if(mWW > 400 && mWW <= 410)  WevtPow2Gen= EvtWeight *2.4806;
      //if(mWW > 410 && mWW <= 420)  WevtPow2Gen= EvtWeight *1.44267;
      //if(mWW > 420 && mWW <= 430)  WevtPow2Gen= EvtWeight *3.24353;
      //if(mWW > 430 && mWW <= 440)  WevtPow2Gen= EvtWeight *3.12501;
      //if(mWW > 440 && mWW <= 450)  WevtPow2Gen= EvtWeight *5.49702;
      //if(mWW > 450 && mWW <= 460)  WevtPow2Gen= EvtWeight *3.54384;
      //if(mWW > 460 && mWW <= 470)  WevtPow2Gen= EvtWeight *3.9357;
      //if(mWW > 470 && mWW <= 480)  WevtPow2Gen= EvtWeight *2.25261;
      //if(mWW > 480 && mWW <= 490)  WevtPow2Gen= EvtWeight *3.38629;
      //if(mWW > 490 && mWW <= 500)  WevtPow2Gen= EvtWeight *3.29891;
      //if(mWW > 500 && mWW <= 510)  WevtPow2Gen= EvtWeight *4.79209;
      //if(mWW > 510 && mWW <= 520)  WevtPow2Gen= EvtWeight *3.7502;
      //if(mWW > 520 && mWW <= 530)  WevtPow2Gen= EvtWeight *4.19026;
      //if(mWW > 530 && mWW <= 540)  WevtPow2Gen= EvtWeight *5.08725;
      //if(mWW > 540 && mWW <= 550)  WevtPow2Gen= EvtWeight *6.24875;
      //if(mWW > 550 && mWW <= 560)  WevtPow2Gen= EvtWeight *6.85355;
      //if(mWW > 560 && mWW <= 570)  WevtPow2Gen= EvtWeight *5.54571;
      //if(mWW > 570 && mWW <= 580)  WevtPow2Gen= EvtWeight *4.66524;
      //if(mWW > 580 && mWW <= 590)  WevtPow2Gen= EvtWeight *7.36091;
      //if(mWW > 590 && mWW <= 600)  WevtPow2Gen= EvtWeight *5.0475;
      //if(mWW > 600 && mWW <= 610)  WevtPow2Gen= EvtWeight *5.06018;
      //if(mWW > 610 && mWW <= 620)  WevtPow2Gen= EvtWeight *7.13992;
      //if(mWW > 620 && mWW <= 630)  WevtPow2Gen= EvtWeight *10.4116;
      //if(mWW > 630 && mWW <= 640)  WevtPow2Gen= EvtWeight *10.8176;
      //if(mWW > 640 && mWW <= 650)  WevtPow2Gen= EvtWeight *11.2285;
      //if(mWW > 650 && mWW <= 660)  WevtPow2Gen= EvtWeight *5.8225;
      //if(mWW > 660 && mWW <= 670)  WevtPow2Gen= EvtWeight *11.8161;
      //if(mWW > 670 && mWW <= 680)  WevtPow2Gen= EvtWeight *12.0013;
      //if(mWW > 680 && mWW <= 690)  WevtPow2Gen= EvtWeight *10.9352;
      //if(mWW > 690 && mWW <= 700)  WevtPow2Gen= EvtWeight *18.4403;
      //if(mWW > 700 && mWW <= 710)  WevtPow2Gen= EvtWeight *12.6074;
      //if(mWW > 710 && mWW <= 720)  WevtPow2Gen= EvtWeight *11.9405;
      //if(mWW > 720 && mWW <= 730)  WevtPow2Gen= EvtWeight *16.7753;
      //if(mWW > 730 && mWW <= 740)  WevtPow2Gen= EvtWeight *20.3525;
      //if(mWW > 740 && mWW <= 750)  WevtPow2Gen= EvtWeight *19.5249;
      //if(mWW > 750 && mWW <= 760)  WevtPow2Gen= EvtWeight *15.3556;
      //if(mWW > 760 && mWW <= 770)  WevtPow2Gen= EvtWeight *14.4621;
      //if(mWW > 770 && mWW <= 780)  WevtPow2Gen= EvtWeight *15.0891;
      //if(mWW > 780 && mWW <= 790)  WevtPow2Gen= EvtWeight *22.4828;
      //if(mWW > 790 && mWW <= 800)  WevtPow2Gen= EvtWeight *21.697;
      //if(mWW > 800 && mWW <= 810)  WevtPow2Gen= EvtWeight *29.438;
      //if(mWW > 810 && mWW <= 820)  WevtPow2Gen= EvtWeight *24.2164;
      //if(mWW > 820 && mWW <= 830)  WevtPow2Gen= EvtWeight *12.9967;
      //if(mWW > 830 && mWW <= 840)  WevtPow2Gen= EvtWeight *27.7654;
      //if(mWW > 840 && mWW <= 850)  WevtPow2Gen= EvtWeight *23.0079;
      //if(mWW > 850 && mWW <= 860)  WevtPow2Gen= EvtWeight *20.8088;
      //if(mWW > 860 && mWW <= 870)  WevtPow2Gen= EvtWeight *16.0907;
      //if(mWW > 870 && mWW <= 880)  WevtPow2Gen= EvtWeight *29.4998;
      //if(mWW > 880 && mWW <= 890)  WevtPow2Gen= EvtWeight *20.2141;
      //if(mWW > 890 && mWW <= 900)  WevtPow2Gen= EvtWeight *20.0894;
      //if(mWW > 900 && mWW <= 910)  WevtPow2Gen= EvtWeight *28.0286;
      //if(mWW > 910 && mWW <= 920)  WevtPow2Gen= EvtWeight *21.8105;
      //if(mWW > 920 && mWW <= 930)  WevtPow2Gen= EvtWeight *22.5122;
      //if(mWW > 930 && mWW <= 940)  WevtPow2Gen= EvtWeight *35.7265;
      //if(mWW > 940 && mWW <= 950)  WevtPow2Gen= EvtWeight *30.6781;
      //if(mWW > 950 && mWW <= 960)  WevtPow2Gen= EvtWeight *41.8656;
      //if(mWW > 960 && mWW <= 970)  WevtPow2Gen= EvtWeight *46.8569;
      //if(mWW > 970 && mWW <= 980)  WevtPow2Gen= EvtWeight *53.0314;
      //if(mWW > 980 && mWW <= 990)  WevtPow2Gen= EvtWeight *27.8172;
      //if(mWW > 990 && mWW <= 1000) WevtPow2Gen= EvtWeight *45.2954;
      //if(mWW > 1000 && mWW <= 1010)WevtPow2Gen= EvtWeight *54.2199;
      //if(mWW > 1010 && mWW <= 1020)WevtPow2Gen= EvtWeight *54.7727;
      //if(mWW > 1020 && mWW <= 1030)WevtPow2Gen= EvtWeight *61.1717;
      //if(mWW > 1030 && mWW <= 1040)WevtPow2Gen= EvtWeight *48.32;
      //if(mWW > 1040 && mWW <= 1050)WevtPow2Gen= EvtWeight *63.2424;
      //if(mWW > 1050 && mWW <= 1060)WevtPow2Gen= EvtWeight *67.4098;
      //if(mWW > 1060 && mWW <= 1070)WevtPow2Gen= EvtWeight *61.7327;
      //if(mWW > 1070 && mWW <= 1080)WevtPow2Gen= EvtWeight *79.2897;
      //if(mWW > 1080 && mWW <= 1090)WevtPow2Gen= EvtWeight *69.2575;
      //if(mWW > 1090 && mWW <= 1100)WevtPow2Gen= EvtWeight *45.9062;
      //if(mWW > 1100 && mWW <= 1110)WevtPow2Gen= EvtWeight *82.2791;
      //if(mWW > 1110 && mWW <= 1120)WevtPow2Gen= EvtWeight *53.4008;
      //if(mWW > 1120 && mWW <= 1130)WevtPow2Gen= EvtWeight *80.2517;
      //if(mWW > 1130 && mWW <= 1140)WevtPow2Gen= EvtWeight *109.322;
      //if(mWW > 1140 && mWW <= 1150)WevtPow2Gen= EvtWeight *64.2948;
      //if(mWW > 1150 && mWW <= 1160)WevtPow2Gen= EvtWeight *93.702;
      //if(mWW > 1160 && mWW <= 1170)WevtPow2Gen= EvtWeight *121.605;
      //if(mWW > 1170 && mWW <= 1180)WevtPow2Gen= EvtWeight *124.533;
      //if(mWW > 1180 && mWW <= 1190)WevtPow2Gen= EvtWeight *136.474;
      //if(mWW > 1190 && mWW <= 1200)WevtPow2Gen= EvtWeight *118.668;
      //if(mWW > 1200 && mWW <= 1210)WevtPow2Gen= EvtWeight *79.1388;
      //if(mWW > 1210 && mWW <= 1220)WevtPow2Gen= EvtWeight *116.174;
      //if(mWW > 1220 && mWW <= 1230)WevtPow2Gen= EvtWeight *102.949;
      //if(mWW > 1230 && mWW <= 1240)WevtPow2Gen= EvtWeight *113.15;
      //if(mWW > 1240 && mWW <= 1250)WevtPow2Gen= EvtWeight *143.089;
      //if(mWW > 1250 && mWW <= 1260)WevtPow2Gen= EvtWeight *187.732;
      //if(mWW > 1260 && mWW <= 1270)WevtPow2Gen= EvtWeight *148.111;
      //if(mWW > 1270 && mWW <= 1280)WevtPow2Gen= EvtWeight *109.009;
      //if(mWW > 1280 && mWW <= 1290)WevtPow2Gen= EvtWeight *332.102;
      //if(mWW > 1290 && mWW <= 1300)WevtPow2Gen= EvtWeight *187.168;
      //if(mWW > 1300 && mWW <= 1310)WevtPow2Gen= EvtWeight *45.5337;
      //if(mWW > 1310 && mWW <= 1320)WevtPow2Gen= EvtWeight *188.16;
      //if(mWW > 1320 && mWW <= 1330)WevtPow2Gen= EvtWeight *249.599;
      //if(mWW > 1330 && mWW <= 1340)WevtPow2Gen= EvtWeight *102.931;
      //if(mWW > 1340 && mWW <= 1350)WevtPow2Gen= EvtWeight *124.151;
      //if(mWW > 1350 && mWW <= 1360)WevtPow2Gen= EvtWeight *81.1671;
      //if(mWW > 1360 && mWW <= 1370)WevtPow2Gen= EvtWeight *231.313;
      //if(mWW > 1370 && mWW <= 1380)WevtPow2Gen= EvtWeight *332.74;
      //if(mWW > 1380 && mWW <= 1390)WevtPow2Gen= EvtWeight *220.912;
      //if(mWW > 1390 && mWW <= 1400)WevtPow2Gen= EvtWeight *522.36;
      //if(mWW > 1400 && mWW <= 1410)WevtPow2Gen= EvtWeight *244.916;
      //if(mWW > 1410 && mWW <= 1420)WevtPow2Gen= EvtWeight *236.616;
      //if(mWW > 1420 && mWW <= 1430)WevtPow2Gen= EvtWeight *304.45;
      //if(mWW > 1430 && mWW <= 1440)WevtPow2Gen= EvtWeight *516.046;
      //if(mWW > 1440 && mWW <= 1450)WevtPow2Gen= EvtWeight *459.926;
      //if(mWW > 1450 && mWW <= 1460)WevtPow2Gen= EvtWeight *530.307;
      //if(mWW > 1460 && mWW <= 1470)WevtPow2Gen= EvtWeight *620.685;
      //if(mWW > 1470 && mWW <= 1480)WevtPow2Gen= EvtWeight *484.239;
      //if(mWW > 1480 && mWW <= 1490)WevtPow2Gen= EvtWeight *96.9447;
      //if(mWW > 1490 && mWW <= 1500)WevtPow2Gen= EvtWeight *651.388;
      //
      if(mWW > 0 && mWW <= 50)     WevtPow2Gen= EvtWeight *0;
      if(mWW > 50 && mWW <= 100)   WevtPow2Gen= EvtWeight *0;
      if(mWW > 100 && mWW <= 150)  WevtPow2Gen= EvtWeight *0;
      if(mWW > 150 && mWW <= 200)  WevtPow2Gen= EvtWeight *0.0378106;
      if(mWW > 200 && mWW <= 250)  WevtPow2Gen= EvtWeight *0.193764;
      if(mWW > 250 && mWW <= 300)  WevtPow2Gen= EvtWeight *1.91155;
      if(mWW > 300 && mWW <= 350)  WevtPow2Gen= EvtWeight *1.61777;
      if(mWW > 350 && mWW <= 400)  WevtPow2Gen= EvtWeight *1.91598;
      if(mWW > 400 && mWW <= 450)  WevtPow2Gen= EvtWeight *2.46773;
      if(mWW > 450 && mWW <= 500)  WevtPow2Gen= EvtWeight *3.14148;
      if(mWW > 500 && mWW <= 550)  WevtPow2Gen= EvtWeight *3.51853;
      if(mWW > 550 && mWW <= 600)  WevtPow2Gen= EvtWeight *5.0784;
      if(mWW > 600 && mWW <= 650)  WevtPow2Gen= EvtWeight *5.52486;
      if(mWW > 650 && mWW <= 700)  WevtPow2Gen= EvtWeight *9.09672;
      if(mWW > 700 && mWW <= 750)  WevtPow2Gen= EvtWeight *13.028;
      if(mWW > 750 && mWW <= 800)  WevtPow2Gen= EvtWeight *16.6288;
      if(mWW > 800 && mWW <= 850)  WevtPow2Gen= EvtWeight *20.2633;
      if(mWW > 850 && mWW <= 900)  WevtPow2Gen= EvtWeight *21.7923;
      if(mWW > 900 && mWW <= 950)  WevtPow2Gen= EvtWeight *22.4597;
      if(mWW > 950 && mWW <= 1000) WevtPow2Gen= EvtWeight *29.4206;
      if(mWW > 1000 && mWW <= 1050)WevtPow2Gen= EvtWeight *45.3205;
      if(mWW > 1050 && mWW <= 1100)WevtPow2Gen= EvtWeight *58.3006;
      if(mWW > 1100 && mWW <= 1150)WevtPow2Gen= EvtWeight *68.2147;
      if(mWW > 1150 && mWW <= 1200)WevtPow2Gen= EvtWeight *79.023;
      if(mWW > 1200 && mWW <= 1250)WevtPow2Gen= EvtWeight *117.26;
      if(mWW > 1250 && mWW <= 1300)WevtPow2Gen= EvtWeight *129.333;
      if(mWW > 1300 && mWW <= 1350)WevtPow2Gen= EvtWeight *166.973;
      if(mWW > 1350 && mWW <= 1400)WevtPow2Gen= EvtWeight *141.288;
      if(mWW > 1400 && mWW <= 1450)WevtPow2Gen= EvtWeight *289.653;
      if(mWW > 1450 && mWW <= 1500)WevtPow2Gen= EvtWeight *393.112;
    }
