...
void HWwNjetStudy::Loop()
{
  ...
  for (int i(0); i<Ntries;i++)
  {
    ...
    if(SampleName == "POWHEG_VBF")
    {
      ...
      if(mWW > 140 && mWW <= 150)  WevtPow2Gen= EvtWeight *0.0260619;
      if(mWW > 150 && mWW <= 160)  WevtPow2Gen= EvtWeight *0.0119112;
      if(mWW > 160 && mWW <= 170)  WevtPow2Gen= EvtWeight *0.019174;
      if(mWW > 170 && mWW <= 180)  WevtPow2Gen= EvtWeight *0.196506;
      if(mWW > 180 && mWW <= 190)  WevtPow2Gen= EvtWeight *0.331655;
      if(mWW > 190 && mWW <= 200)  WevtPow2Gen= EvtWeight *0.440528;
      if(mWW > 200 && mWW <= 210)  WevtPow2Gen= EvtWeight *0.562389;
      if(mWW > 210 && mWW <= 220)  WevtPow2Gen= EvtWeight *1.17838;
      if(mWW > 220 && mWW <= 230)  WevtPow2Gen= EvtWeight *20.6026;
      if(mWW > 230 && mWW <= 240)  WevtPow2Gen= EvtWeight *25.4218;
      if(mWW > 240 && mWW <= 250)  WevtPow2Gen= EvtWeight *14.183;
      if(mWW > 250 && mWW <= 260)  WevtPow2Gen= EvtWeight *1.43085;
      if(mWW > 260 && mWW <= 270)  WevtPow2Gen= EvtWeight *1.37039;
      if(mWW > 270 && mWW <= 280)  WevtPow2Gen= EvtWeight *11.4456;
      if(mWW > 280 && mWW <= 290)  WevtPow2Gen= EvtWeight *13.7121;
      if(mWW > 290 && mWW <= 300)  WevtPow2Gen= EvtWeight *7.60128;
      if(mWW > 300 && mWW <= 310)  WevtPow2Gen= EvtWeight *1.5892;
      if(mWW > 310 && mWW <= 320)  WevtPow2Gen= EvtWeight *1.50643;
      if(mWW > 320 && mWW <= 330)  WevtPow2Gen= EvtWeight *6.18229;
      if(mWW > 330 && mWW <= 340)  WevtPow2Gen= EvtWeight *7.62895;
      if(mWW > 340 && mWW <= 350)  WevtPow2Gen= EvtWeight *4.84951;
      if(mWW > 350 && mWW <= 360)  WevtPow2Gen= EvtWeight *1.80433;
      if(mWW > 360 && mWW <= 370)  WevtPow2Gen= EvtWeight *1.68714;
      if(mWW > 370 && mWW <= 380)  WevtPow2Gen= EvtWeight *3.76794;
      if(mWW > 380 && mWW <= 390)  WevtPow2Gen= EvtWeight *4.88623;
      if(mWW > 390 && mWW <= 400)  WevtPow2Gen= EvtWeight *3.7266;
      if(mWW > 400 && mWW <= 410)  WevtPow2Gen= EvtWeight *2.40409;
      if(mWW > 410 && mWW <= 420)  WevtPow2Gen= EvtWeight *2.40747;
      if(mWW > 420 && mWW <= 430)  WevtPow2Gen= EvtWeight *2.9339;
      if(mWW > 430 && mWW <= 440)  WevtPow2Gen= EvtWeight *3.56466;
      if(mWW > 440 && mWW <= 450)  WevtPow2Gen= EvtWeight *3.39368;
      if(mWW > 450 && mWW <= 460)  WevtPow2Gen= EvtWeight *2.81488;
      if(mWW > 460 && mWW <= 470)  WevtPow2Gen= EvtWeight *2.76071;
      if(mWW > 470 && mWW <= 480)  WevtPow2Gen= EvtWeight *3.0608;
      if(mWW > 480 && mWW <= 490)  WevtPow2Gen= EvtWeight *3.31189;
      if(mWW > 490 && mWW <= 500)  WevtPow2Gen= EvtWeight *3.2105;
      if(mWW > 500 && mWW <= 510)  WevtPow2Gen= EvtWeight *3.13052;
      if(mWW > 510 && mWW <= 520)  WevtPow2Gen= EvtWeight *2.91649;
      if(mWW > 520 && mWW <= 530)  WevtPow2Gen= EvtWeight *3.14123;
      if(mWW > 530 && mWW <= 540)  WevtPow2Gen= EvtWeight *3.24706;
      if(mWW > 540 && mWW <= 550)  WevtPow2Gen= EvtWeight *3.44298;
      if(mWW > 550 && mWW <= 560)  WevtPow2Gen= EvtWeight *3.4391;
      if(mWW > 560 && mWW <= 570)  WevtPow2Gen= EvtWeight *3.58728;
      if(mWW > 570 && mWW <= 580)  WevtPow2Gen= EvtWeight *3.3142;
      if(mWW > 580 && mWW <= 590)  WevtPow2Gen= EvtWeight *3.91778;
      if(mWW > 590 && mWW <= 600)  WevtPow2Gen= EvtWeight *3.85966;
      if(mWW > 600 && mWW <= 610)  WevtPow2Gen= EvtWeight *4.03746;
      if(mWW > 610 && mWW <= 620)  WevtPow2Gen= EvtWeight *4.35108;
      if(mWW > 620 && mWW <= 630)  WevtPow2Gen= EvtWeight *4.90202;
      if(mWW > 630 && mWW <= 640)  WevtPow2Gen= EvtWeight *4.75501;
      if(mWW > 640 && mWW <= 650)  WevtPow2Gen= EvtWeight *5.32443;
      if(mWW > 650 && mWW <= 660)  WevtPow2Gen= EvtWeight *5.31083;
      if(mWW > 660 && mWW <= 670)  WevtPow2Gen= EvtWeight *5.9124;
      if(mWW > 670 && mWW <= 680)  WevtPow2Gen= EvtWeight *6.3957;
      if(mWW > 680 && mWW <= 690)  WevtPow2Gen= EvtWeight *6.15446;
      if(mWW > 690 && mWW <= 700)  WevtPow2Gen= EvtWeight *6.14332;
      if(mWW > 700 && mWW <= 710)  WevtPow2Gen= EvtWeight *6.53771;
      if(mWW > 710 && mWW <= 720)  WevtPow2Gen= EvtWeight *6.44235;
      if(mWW > 720 && mWW <= 730)  WevtPow2Gen= EvtWeight *6.66971;
      if(mWW > 730 && mWW <= 740)  WevtPow2Gen= EvtWeight *6.98304;
      if(mWW > 740 && mWW <= 750)  WevtPow2Gen= EvtWeight *6.99574;
      if(mWW > 750 && mWW <= 760)  WevtPow2Gen= EvtWeight *7.25158;
      if(mWW > 760 && mWW <= 770)  WevtPow2Gen= EvtWeight *7.24977;
      if(mWW > 770 && mWW <= 780)  WevtPow2Gen= EvtWeight *7.72243;
      if(mWW > 780 && mWW <= 790)  WevtPow2Gen= EvtWeight *8.07475;
      if(mWW > 790 && mWW <= 800)  WevtPow2Gen= EvtWeight *8.32101;
      if(mWW > 800 && mWW <= 810)  WevtPow2Gen= EvtWeight *8.25511;
      if(mWW > 810 && mWW <= 820)  WevtPow2Gen= EvtWeight *8.43554;
      if(mWW > 820 && mWW <= 830)  WevtPow2Gen= EvtWeight *9.23788;
      if(mWW > 830 && mWW <= 840)  WevtPow2Gen= EvtWeight *8.27669;
      if(mWW > 840 && mWW <= 850)  WevtPow2Gen= EvtWeight *9.43735;
      if(mWW > 850 && mWW <= 860)  WevtPow2Gen= EvtWeight *9.90311;
      if(mWW > 860 && mWW <= 870)  WevtPow2Gen= EvtWeight *9.69826;
      if(mWW > 870 && mWW <= 880)  WevtPow2Gen= EvtWeight *10.5317;
      if(mWW > 880 && mWW <= 890)  WevtPow2Gen= EvtWeight *10.6142;
      if(mWW > 890 && mWW <= 900)  WevtPow2Gen= EvtWeight *9.67802;
      if(mWW > 900 && mWW <= 910)  WevtPow2Gen= EvtWeight *12.5784;
      if(mWW > 910 && mWW <= 920)  WevtPow2Gen= EvtWeight *11.426;
      if(mWW > 920 && mWW <= 930)  WevtPow2Gen= EvtWeight *10.9425;
      if(mWW > 930 && mWW <= 940)  WevtPow2Gen= EvtWeight *13.117;
      if(mWW > 940 && mWW <= 950)  WevtPow2Gen= EvtWeight *14.5162;
      if(mWW > 950 && mWW <= 960)  WevtPow2Gen= EvtWeight *14.7025;
      if(mWW > 960 && mWW <= 970)  WevtPow2Gen= EvtWeight *13.5583;
      if(mWW > 970 && mWW <= 980)  WevtPow2Gen= EvtWeight *13.5846;
      if(mWW > 980 && mWW <= 990)  WevtPow2Gen= EvtWeight *12.9773;
      if(mWW > 990 && mWW <= 1000) WevtPow2Gen= EvtWeight *15.8861;
      if(mWW > 1000 && mWW <= 1010)WevtPow2Gen= EvtWeight *14.733;
      if(mWW > 1010 && mWW <= 1020)WevtPow2Gen= EvtWeight *15.4643;
      if(mWW > 1020 && mWW <= 1030)WevtPow2Gen= EvtWeight *14.6679;
      if(mWW > 1030 && mWW <= 1040)WevtPow2Gen= EvtWeight *16.4182;
      if(mWW > 1040 && mWW <= 1050)WevtPow2Gen= EvtWeight *17.9151;
      if(mWW > 1050 && mWW <= 1060)WevtPow2Gen= EvtWeight *18.7079;
      if(mWW > 1060 && mWW <= 1070)WevtPow2Gen= EvtWeight *21.6549;
      if(mWW > 1070 && mWW <= 1080)WevtPow2Gen= EvtWeight *22.155;
      if(mWW > 1080 && mWW <= 1090)WevtPow2Gen= EvtWeight *19.2925;
      if(mWW > 1090 && mWW <= 1100)WevtPow2Gen= EvtWeight *23.9451;
      if(mWW > 1100 && mWW <= 1110)WevtPow2Gen= EvtWeight *21.2341;
      if(mWW > 1110 && mWW <= 1120)WevtPow2Gen= EvtWeight *20.147;
      if(mWW > 1120 && mWW <= 1130)WevtPow2Gen= EvtWeight *22.361;
      if(mWW > 1130 && mWW <= 1140)WevtPow2Gen= EvtWeight *23.0907;
      if(mWW > 1140 && mWW <= 1150)WevtPow2Gen= EvtWeight *27.6386;
      if(mWW > 1150 && mWW <= 1160)WevtPow2Gen= EvtWeight *23.5834;
      if(mWW > 1160 && mWW <= 1170)WevtPow2Gen= EvtWeight *31.9;
      if(mWW > 1170 && mWW <= 1180)WevtPow2Gen= EvtWeight *30.0675;
      if(mWW > 1180 && mWW <= 1190)WevtPow2Gen= EvtWeight *25.1825;
      if(mWW > 1190 && mWW <= 1200)WevtPow2Gen= EvtWeight *33.8603;
      if(mWW > 1200 && mWW <= 1210)WevtPow2Gen= EvtWeight *30.2205;
      if(mWW > 1210 && mWW <= 1220)WevtPow2Gen= EvtWeight *32.817;
      if(mWW > 1220 && mWW <= 1230)WevtPow2Gen= EvtWeight *36.2287;
      if(mWW > 1230 && mWW <= 1240)WevtPow2Gen= EvtWeight *38.2718;
      if(mWW > 1240 && mWW <= 1250)WevtPow2Gen= EvtWeight *32.7638;
      if(mWW > 1250 && mWW <= 1260)WevtPow2Gen= EvtWeight *50.0627;
      if(mWW > 1260 && mWW <= 1270)WevtPow2Gen= EvtWeight *50.6885;
      if(mWW > 1270 && mWW <= 1280)WevtPow2Gen= EvtWeight *50.2835;
      if(mWW > 1280 && mWW <= 1290)WevtPow2Gen= EvtWeight *47.5275;
      if(mWW > 1290 && mWW <= 1300)WevtPow2Gen= EvtWeight *62.8351;
      if(mWW > 1300 && mWW <= 1310)WevtPow2Gen= EvtWeight *61.6952;
      if(mWW > 1310 && mWW <= 1320)WevtPow2Gen= EvtWeight *63.4777;
      if(mWW > 1320 && mWW <= 1330)WevtPow2Gen= EvtWeight *70.7116;
      if(mWW > 1330 && mWW <= 1340)WevtPow2Gen= EvtWeight *57.7858;
      if(mWW > 1340 && mWW <= 1350)WevtPow2Gen= EvtWeight *46.1276;
      if(mWW > 1350 && mWW <= 1360)WevtPow2Gen= EvtWeight *39.2811;
      if(mWW > 1360 && mWW <= 1370)WevtPow2Gen= EvtWeight *60.9311;
      if(mWW > 1370 && mWW <= 1380)WevtPow2Gen= EvtWeight *75.7118;
      if(mWW > 1380 && mWW <= 1390)WevtPow2Gen= EvtWeight *50.6159;
      if(mWW > 1390 && mWW <= 1400)WevtPow2Gen= EvtWeight *88.5277;
      if(mWW > 1400 && mWW <= 1410)WevtPow2Gen= EvtWeight *75.2436;
      if(mWW > 1410 && mWW <= 1420)WevtPow2Gen= EvtWeight *79.1027;
      if(mWW > 1420 && mWW <= 1430)WevtPow2Gen= EvtWeight *66.6255;
      if(mWW > 1430 && mWW <= 1440)WevtPow2Gen= EvtWeight *110.828;
      if(mWW > 1440 && mWW <= 1450)WevtPow2Gen= EvtWeight *87.1579;
      if(mWW > 1450 && mWW <= 1460)WevtPow2Gen= EvtWeight *97.0917;
      if(mWW > 1460 && mWW <= 1470)WevtPow2Gen= EvtWeight *95.6934;
      if(mWW > 1470 && mWW <= 1480)WevtPow2Gen= EvtWeight *120.558;
      if(mWW > 1480 && mWW <= 1490)WevtPow2Gen= EvtWeight *58.6918;
      if(mWW > 1490 && mWW <= 1500)WevtPow2Gen= EvtWeight *98.2774;
      //
      //
    }
